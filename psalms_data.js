...
{ label: "Introduction",
	  ...
	  image: "lyre.png",
      text: `
        <p>The Psalms are the prayer book of <span class="tooltip">God&#8217;s people<span class="tooltiptext">In the Old Testament, the nation of Israel &#8212; chosen, called, and covenanted by God. In the New Testament, all who are united to Christ by faith and Baptism, grafted into the same covenant promises. The Psalms were written by and for Israel and inherited by the Church as its own prayer book.</span></span> &#8212; an anthology of <span class="tooltip">hymns<span class="tooltiptext">Songs of direct praise to God, celebrating who He is and what He has done. Hymns are a distinct genre within the Psalter, often structured around a call to praise, the reasons for that praise, and a renewed call. Examples: Psalms 8, 19, 100, 103, 145&#8211;150.</span></span>, <span class="tooltip">laments<span class="tooltiptext">A direct, urgent cry to God in suffering &#8212; the most common genre in the Psalter. Lament is not faithlessness; it is the prayer of a person who believes God hears and is capable of acting.</span></span>, and songs of praise spanning many authors and centuries, gathered into the <span class="tooltip">Old Testament<span class="tooltiptext">The 39 books of Israel&#8217;s scripture, which Christians received as the first part of the Bible &#8212; preparatory to and fulfilled in Christ. Also called the Hebrew Bible in academic contexts. Organized in Hebrew into three sections: Torah (Law), Nevi&#8217;im (Prophets), and Ketuvim (Writings). The Psalms belong to the Ketuvim.</span></span> as the Psalter. Their Hebrew title, <span class="tooltip">Tehillim<span class="tooltiptext"><em>teh-hil-EEM</em><br><span style="font-size:1.4em;">תְּהִלִּים</span> &#8212; Hebrew plural of tehillah (praise, song of praise), from the root halal, &#8220;to praise.&#8221; The singular tehillah appears as the title of Psalm 145 &#8212; the only psalm whose superscription uses this word.</span></span>, means &#8220;Praises&#8221; &#8212; though lament dominates much of the interior, the collection ends in pure <span class="tooltip">doxology<span class="tooltiptext"><em>dok-SOL-uh-jee</em><br>An expression of praise directed to God. Each of the Psalter&#8217;s five books closes with one, and the final five psalms (146&#8211;150) are pure doxology from beginning to end &#8212; each opening and closing with &#8220;Hallelujah&#8221; (Praise the LORD).</span></span>, and the title reflects that ending.</p>
        <p style="margin: 5px 0 0;">Known in English as the <strong>Psalms</strong> and in formal worship as the <strong>Psalter</strong> &#8212; both names refer to the same book. Lutheran, Catholic, and Anglican traditions favor <em>Psalter</em> in their <span class="tooltip">liturgy<span class="tooltiptext"><em>LIT-ur-jee</em><br>The ordered, formal pattern of public Christian worship &#8212; the prayers, Scripture readings, creeds, hymns, and sacraments that structure corporate gatherings of the Church.</span></span>.</p>
		`,
      ref: "Selah Amen",
      insight: `<div class="intro-sections">
<button id="accordion-demo-btn" style="font-family:Courier New,monospace;font-size:13px;background:none;border:none;padding:0;cursor:pointer;margin-bottom:8px;" title="Click to see how the sections work" onclick="var d=document.getElementById('accordion-demo');if(d.style.display==='none'){d.style.display='block';}else{d.style.display='none';}">[?]</button>
...
<summary>This is what an expandable subject looks like</summary>
...
<p><strong>Tooltips</strong> &#8212; Terms with a dotted underline reveal a definition when hovered or tapped. Try it: <span class="tooltip">this term<span class="tooltiptext">This is a tooltip &#8212; a short definition or explanation that appears when you hover or tap a dotted-underline word. Hebrew and Greek words include the original text, transliteration, and meaning.</span></span>. Tooltips appear throughout the study on key terms, Hebrew words, and concepts.</p>
...
<p>
These pages are a verse-by-verse <span class="tooltip">exegetical<span class="tooltiptext"><em>ek-suh-JET-ih-kul</em> (exegesis: <em>ek-suh-JEE-sis</em>)<br>From exegesis &#8212; drawing the meaning out of the text itself through careful analysis of the original language, grammar, and historical context. The opposite of reading a meaning into the text that is not already there.</span></span> study of the Psalms. Each verse is examined word by word: Hebrew text with <span class="tooltip">transliteration<span class="tooltiptext"><em>trans-lit-er-AY-shun</em><br>Rendering a word&#8217;s sounds into the letters of another alphabet &#8212; not a translation of what it means, but a representation of how it sounds. For example, the Hebrew <span class="hebrew-text" dir="rtl">שָׁלוֹם</span> becomes <em>shalom</em> in English letters.</span></span> and grammatical analysis, <span class="tooltip">covenantal and theological context<span class="tooltiptext"><strong>Covenantal context</strong> &#8212; where the verse fits within God&#8217;s unfolding promises: the covenants with Adam, Abraham, Moses, and David, and their fulfillment in Christ.<br><br><strong>Theological context</strong> &#8212; what doctrinal category the verse speaks to: Law or Gospel, the nature of prayer, justification, or the character of God.</span></span>, parallel passages from across Scripture, and major English translations available to view and compare. The goal is precision &#8212; to know exactly what is written, what it means, and why it matters.
</p>
<p>
This study reads the Psalms from a <span class="tooltip">confessional<span class="tooltiptext">Subscribing to specific historic statements of faith &#8212; creeds, catechisms, and confessions &#8212; as authoritative summaries of what Scripture teaches. A confessional church is bound to those documents, not merely broadly Christian in a general sense.</span></span> <span class="tooltip">Lutheran<span class="tooltiptext">A tradition of Christian theology rooted in the 16th-century Reformation work of Martin Luther. Core commitments: Scripture alone as the supreme authority (<em>Sola Scriptura</em> &#8212; SOH-lah SKRIP-tyoo-rah), justification by grace through faith alone (<em>Sola Gratia</em> &#8212; SOH-lah GRAH-tee-ah; <em>Sola Fide</em> &#8212; SOH-lah FEE-day), and the means of grace &#8212; Word and Sacraments &#8212; as the channels through which God delivers forgiveness and life.</span></span> (<span class="tooltip">LCMS<span class="tooltiptext">The Lutheran Church&#8212;Missouri Synod. A confessional Lutheran denomination in the United States that affirms biblical inerrancy (that Scripture in its original manuscripts contains no errors) and subscribes to the Lutheran confessional documents, including the Augsburg Confession, Luther&#8217;s Small and Large Catechisms, and the Formula of Concord.</span></span>) perspective &#8212; the tradition that reads them the way Christ read them: as written about Him from the beginning. It reads every passage through the <span class="tooltip">Law and Gospel<span class="tooltiptext">The central distinction in Lutheran theology. The Law is everything Scripture says about what God demands &#8212; it reveals sin, condemns, and shows what is owed but cannot be paid. The Gospel is everything Scripture says about what God gives &#8212; the promise of forgiveness, life, and salvation in Christ, received by faith alone. Every biblical text functions as one or the other.</span></span> distinction: never reading God&#8217;s commands as promises, or His promises as commands.
</p>
<p>
Where the Psalms describe what David himself never experienced, those words speak of Christ. David was not crucified. The <span class="tooltip">Holy Spirit<span class="tooltiptext">The third person of the Trinity and the divine author of Scripture. The biblical writers wrote in their own voice and style, but the Holy Spirit carried them — the words are theirs, the meaning and content are God&#8217;s. <small>2 Peter 1:21</small></span></span> wrote through David about Christ &#8212; pierced hands and feet, bones disjointed, garments divided, a reign without end. The Psalms are <span class="tooltip">prophetic Scripture<span class="tooltiptext">Scripture that speaks of future events &#8212; not prediction in a fortune-telling sense, but God declaring what He will do before He does it. The Psalms are prophetic in that the Holy Spirit placed words in David&#8217;s mouth describing Christ&#8217;s life, death, and resurrection centuries before they occurred.</span></span>, written by the Spirit who knew what was coming. <span class="cite-anchor" id="cite-intro-2">David held the office of king, but the <span class="tooltip">covenant<span class="tooltiptext">God&#8217;s binding promise to His people, established on His initiative. The biblical covenants &#8212; with Adam, Noah, Abraham, Moses, and David &#8212; each carry the same central promise forward: God will be their God, they will be His people, and He will send One to restore what sin destroyed. The New Covenant in Christ fulfills them all.</span></span> always pointed beyond him to the King whom his throne foreshadowed.<sup class="ref"><a href="#ref-intro-2">[2]</a></sup></span> These were never David&#8217;s words about himself; they were always Christ&#8217;s, given to David to carry. <span class="cite-anchor" id="cite-intro-3">Christ himself confirmed it &#8212; he told his disciples that the Psalms speak of him.<sup class="ref"><a href="#ref-intro-3">[3]</a></sup></span>
</p>
<p>
The Law and Gospel distinction asks of every text whether it exposes sin &#8212; the righteousness that cannot be met &#8212; or announces the forgiveness and life God gives in Christ. It fits because the Psalms themselves move this way: from confession to absolution, from lament to deliverance, from what is condemned to what is forgiven. The two cannot be mixed: softening the Law hides sin; turning the Gospel into a demand buries grace.
</p>
<p>
...
<div class="image-text-row" style="display: flex; gap: 1.5em; align-items: center; margin-top: 0.75em;">
  ...
  <div>
    ...
    <p>This is the lens through which this study reads the Psalms: the cross at the center, the heart kept alive by it, joy in the promise, hope fixed on what is coming, and the blessedness that has no end.</p>
  </div>
</div>
</details>
<details class="study-section">
...
<p>
This is why Luther used the Psalms in personal devotion, in public worship, in catechesis, and in <span class="tooltip">pastoral<span class="tooltiptext">From the Latin pastor, &#8220;shepherd&#8221; &#8212; the care of souls, the way a shepherd tends a flock. Guiding someone toward prayer and faith, not merely explaining a text to them.</span></span> care. He did not treat them as ancient documents to be studied from a distance &#8212; he prayed them. A reader who wants to do the same can use the &#8220;Find a psalm for...&#8221; tool at the bottom of each card, below &#8220;Jump to.&#8221;
</p>
<hr>
...
<li><strong>Book III</strong> &#8212; Psalms 73&#8211;89 (Asaph and <span class="tooltip">others<span class="tooltiptext">Sons of Korah (Pss 84&#8211;85, 87&#8211;88), David (Ps 86), Ethan the Ezrahite (Ps 89)</span></span>; exile and <span class="tooltip">theodicy<span class="tooltiptext"><em>thee-OD-ih-see</em><br>The problem of reconciling God&#8217;s goodness and power with the existence of suffering and evil. Many Asaph psalms wrestle directly with this question &#8212; why do the wicked prosper and the righteous suffer? Book III contains the Psalter&#8217;s most sustained wrestling with God&#8217;s apparent hiddenness.</span></span>)</li>
<li><strong>Book IV</strong> &#8212; Psalms 90&#8211;106 (Moses, anonymous; God&#8217;s reign over all nations)</li>
<li><strong>Book V</strong> &#8212; Psalms 107&#8211;150 (<span class="tooltip">praise crescendo<span class="tooltiptext">The Psalter builds toward praise across its five books. Lament dominates the early psalms; thanksgiving and trust grow through the middle; Book V arrives at sustained, unbroken praise. The collection is structured so that no matter where the reader enters &#8212; grief, fear, repentance &#8212; the whole arc carries him toward doxology.</span></span>; ends in pure <span class="tooltip">doxology<span class="tooltiptext"><em>dok-SOL-uh-jee</em><br>An expression of praise directed to God. Each of the Psalter&#8217;s five books closes with one, and the final five psalms (146&#8211;150) are pure doxology from beginning to end &#8212; each opening and closing with &#8220;Hallelujah&#8221; (Praise the LORD).</span></span>)</li>
</ul>
<p>
Within this structure the psalms are grouped by author, catchword, genre, and liturgical use &#8212; not chronology. The <span class="tooltip">superscriptions<span class="tooltiptext">From the Latin <em>superscriptio</em> &#8212; &#8220;written above.&#8221; The Hebrew titles that appear at the head of 116 of the 150 psalms, containing information about authorship, musical instructions, historical occasion, or genre &#8212; for example, &#8220;A Psalm of David, when he fled from Absalom his son&#8221; (Psalm 3), or &#8220;To the choirmaster, with stringed instruments&#8221; (Psalm 4). They are part of the Masoretic Text &#8212; the authoritative Hebrew Bible &#8212; and are treated as canonical by both Jewish and Christian tradition, though sometimes printed in smaller type or set apart from the psalm body in modern editions.</span></span> confirm this: psalms with historical headings (&#8220;when he fled from Absalom,&#8221; &#8220;after Nathan came to him&#8221;) are scattered throughout the Psalter with no regard for the order those events occurred in David&#8217;s life.
</p>
<p>
...
<p>
The Psalms were written across many centuries, by many authors, for many occasions, so they are not all the same kind of prayer. The Psalter contains distinct literary genres &#8212; recognizable patterns of structure, voice, and purpose &#8212; and knowing which genre a psalm belongs to tells you what it is doing: crying out in lament, celebrating in praise, confessing sin, or teaching wisdom.
</p>
<p>
Genres can overlap. A psalm may begin as a lament and end in praise. A <span class="tooltip">royal psalm<span class="tooltiptext">A psalm concerning the Davidic king &#8212; his coronation, reign, or victories &#8212; often using language too large for any human ruler to fulfill.</span></span> may contain a confession. The categories below are not strict boundaries but patterns, recurring across the Psalter and giving each psalm its shape.
</p>
<hr>
<p><strong>Lament</strong></p>
<p>
The most common genre in the Psalter. A lament is a direct, urgent cry to God in the midst of suffering &#8212; individual or corporate. Lament is not faithlessness or despair. It is the prayer of a person who believes God hears, is capable of acting, and has not yet acted. The very act of crying out to God is itself a declaration of trust.
</p>
<p>
Most individual laments follow a recognizable structure: <strong>address</strong> (calling on God by name), <strong>complaint</strong> (describing the crisis honestly), <strong>petition</strong> (asking God to act), <strong>expression of trust</strong> (recalling who God is and what He has done), and often a <strong>vow of praise</strong> (committing to give thanks when God delivers). This movement &#8212; from crisis to trust &#8212; is the defining arc of the lament psalm. It does not mean the crisis is resolved. It means the soul has moved through the crisis into the hands of God.
</p>
<p><small>Individual lament: Psalms 3, 5, 6, 13, 22, 51 &#8212; Communal lament: Psalms 44, 74, 79, 80</small></p>
<hr>
...
<p>
The New Testament carries this tradition forward explicitly. Hebrews 13:15 calls for &#8220;a sacrifice of praise &#8212; the fruit of lips that acknowledge his name&#8221; &#8212; naming the Christian life itself as the fulfillment of the <em>todah</em> offering. And Christ&#8217;s institution of the Lord&#8217;s Supper, followed by singing a hymn (Matthew 26:30 &#8212; almost certainly the <span class="tooltip">Hallel<span class="tooltiptext"><em>hah-LEL</em><br>Psalms 113&#8211;118, sung at the Passover meal. <em>Hallel</em> means praise. These psalms move from Israel&#8217;s deliverance in Egypt (Ps 113&#8211;114) through trust in God (Ps 115&#8211;116) to universal praise (Ps 117&#8211;118). They end with Psalm 118: &#8220;The stone the builders rejected has become the cornerstone&#8221; &#8212; which Christ applies to Himself in Matthew 21:42.</span></span>, Psalms 113&#8211;118), places the Church&#8217;s central act of worship squarely in this tradition. The word <em>Eucharist</em> comes from the Greek <em>eucharistia</em> &#8212; thanksgiving.
</p>
<p><small>Psalms 30, 34, 41, 66, 92, 107, 116, 118, 138</small></p>
<hr>
<p><strong>Royal</strong></p>
<p>
Psalms concerning the king &#8212; his coronation, his warfare, his marriage, his reign, his prayer. The royal psalms make claims about the king that exceed anything an ordinary human ruler could fulfill: a reign to the ends of the earth, an eternal throne, divine sonship, victory over all enemies. David and Solomon never received what these psalms describe. The language is bigger than its human subject &#8212; which is precisely why the New Testament authors read them as <span class="tooltip">messianic<span class="tooltiptext"><em>mess-ee-AN-ik</em><br>Relating to the Messiah &#8212; the anointed deliverer promised throughout the Hebrew Scriptures. In the New Testament, Jesus of Nazareth is identified as the fulfillment of these promises: the Son of David, the eternal King, the one who inherits the nations and rules from Zion. The royal psalms find their full referent not in any human king but in Christ.</span></span>. Psalm 2 is quoted in Acts 13 and Hebrews 1 to establish Christ&#8217;s identity. Psalm 110:1 is the single most-quoted Old Testament verse in the New Testament.
</p>
<p><small>Psalms 2, 18, 20, 21, 45, 72, 89, 101, 110, 132, 144</small></p>
<hr>
<p><strong>Wisdom</strong></p>
<p>
Psalms that teach &#8212; reflecting on the patterns of life, the contrast between the righteous and the wicked, the nature of suffering and prosperity, the fear of God as the foundation of understanding. Wisdom psalms share vocabulary and concerns with Proverbs and Job. They do not address God in direct petition so much as instruct the reader in the way of life. Psalm 1, which opens the entire Psalter, is a wisdom psalm &#8212; it frames everything that follows as a choice between two paths.
</p>
<p><small>Psalms 1, 37, 49, 73, 112, 119, 127, 128, 133</small></p>
<hr>
<p><strong>Penitential</strong> <small><em>(peh-nih-TEN-shul)</em></small></p>
<p>
Psalms of confession &#8212; the soul before God owning its sin, receiving judgment as just, and appealing to God&#8217;s mercy rather than to any righteousness of its own. The Church has historically identified seven penitential psalms, a grouping rooted in early Christian devotion and used in liturgical prayer through the centuries. Psalm 51 &#8212; David&#8217;s confession after the sin with Bathsheba &#8212; is the most complete and most studied of the seven.
</p>
<p><small>The seven penitential psalms: 6, 32, 38, 51, 102, 130, 143</small></p>
<hr>
<p><strong>Songs of Ascent</strong></p>
<p>
...
<hr>
<p><strong>Imprecatory</strong> <small><em>(IM-preh-kuh-tor-ee)</em></small></p>
<p>
...
<p>
<strong>Third, the New Testament does not abandon these psalms &#8212; it uses them.</strong> <span class="cite-anchor" id="cite-intro-15">Psalm 69 is one of the most <span class="tooltip">messianically applied<span class="tooltiptext">Cited or interpreted in the New Testament as finding their fulfillment in Christ. Psalm 69 is quoted more frequently in the New Testament than any other psalm except Psalm 22 and Psalm 110.</span></span> psalms in the New Testament.<sup class="ref"><a href="#ref-intro-15">[15]</a></sup></span> Jesus quotes it from the cross: &#8220;I thirst&#8221; fulfills Psalm 69:21. John 2:17 applies Psalm 69:9 to Christ&#8217;s cleansing of the Temple. Peter quotes the imprecatory verse of Psalm 109 &#8212; &#8220;May his office another take&#8221; &#8212; to justify choosing a replacement for Judas. <small>Acts 1:20</small> The apostles did not edit out the judgment portions. They recognized them as part of the same Spirit-breathed text that promises mercy.
</p>
<p>
<span class="cite-anchor" id="cite-intro-16"><span class="tooltip">Luther<span class="tooltiptext">In his lectures on the Psalms (<em>Dictata super Psalterium</em>, 1513&#8211;1515) and later writings, Luther interpreted the imprecatory psalms as the voice of the Church under persecution, crying out for God&#8217;s vindication. He did not read them as the personal malice of the individual psalmist but as the just complaint of the people of God against sin, death, and the devil.</span></span> read the imprecatory psalms as the voice of the Church under persecution crying out for God&#8217;s judgment on evil itself &#8212; sin, death, the devil, and their instruments in history. They are not the expression of a private grudge. They are the prayer of the oppressed that God would be what He has declared Himself to be: a God of justice. The final answer to these prayers is not an army &#8212; it is the Last Day, when God will judge the living and the dead and all things will be made right.<sup class="ref"><a href="#ref-intro-16">[16]</a></sup></span>
</p>
...
<p>
The Psalms are poems, and Hebrew poetry works differently from English poetry. English verse depends on <span class="tooltip">meter<span class="tooltiptext">A regular rhythmic pattern in verse, organized by stressed and unstressed syllables. English poetry (Shakespeare, Milton, Keats) depends heavily on meter &#8212; iambic pentameter being the most common form. Hebrew verse has approximate stress patterns but is not primarily metrical in the strict English sense.</span></span> and rhyme; Hebrew verse depends on <strong>parallelism</strong> &#8212; the relationship between one line and the next.
</p>
<p>
Parallelism is the single most important tool a reader can bring to the Psalter. Every psalm uses it, from the first line to the last. Understanding it changes what a reader hears when the text appears to repeat itself &#8212; because it almost never does.
</p>
<hr>
<p><strong>Synonymous Parallelism &#8212; the second line restates the first</strong></p>
<p>
The second line says the same thing as the first &#8212; but with different words, different images, or greater intensity. It is not repetition. It is deepening.
</p>
<blockquote>
<em>&#8220;The heavens declare the glory of God, /<br>
and the sky above proclaims his handiwork.&#8221;</em><br>
<small>Psalm 19:1</small>
</blockquote>
<p>
&#8220;Heavens&#8221; and &#8220;sky above&#8221; are not two different locations. &#8220;Declare&#8221; and &#8220;proclaims&#8221; are not two different actions. The second line does what a second brushstroke does &#8212; it fills in the same image with more detail, more weight. The reader is meant to dwell longer in the idea, not move past it.
</p>
<blockquote>
<em>&#8220;O LORD, how many are my foes! /<br>
Many are rising against me.&#8221;</em><br>
<small>Psalm 3:1</small>
</blockquote>
<p>
The second line here is not adding a new fact &#8212; it is pressing the first line deeper into the reader&#8217;s hearing. The repetition of &#8220;many&#8221; is the point. David is surrounded and overwhelmed, and the poetry replicates that feeling by refusing to move on.
</p>
<hr>
<p><strong>Antithetic Parallelism &#8212; the second line contrasts the first</strong></p>
<p>
The second line sets the first line against its opposite. The contrast is the meaning. Both lines are needed to see what either one is saying.
</p>
<blockquote>
<em>&#8220;For the LORD knows the way of the righteous, /<br>
but the way of the wicked will perish.&#8221;</em><br>
<small>Psalm 1:6</small>
</blockquote>
<p>
This is the closing verse of Psalm 1 &#8212; and it is the entire psalm compressed into two lines. The righteous are known by God; the wicked perish. Two paths, set side by side. Neither line makes full sense without the other. Antithetic parallelism is the poetry of the <span class="tooltip">Law and Gospel<span class="tooltiptext">The central distinction in Lutheran theology. The Law is everything Scripture says about what God demands &#8212; it reveals sin, condemns, and shows what is owed but cannot be paid. The Gospel is everything Scripture says about what God gives &#8212; the promise of forgiveness, life, and salvation in Christ, received by faith alone. Every biblical text functions as one or the other.</span></span> distinction carried into verse &#8212; what God demands and what happens when it is not met, placed directly against what God gives and where it leads.
</p>
<hr>
<p><strong>Synthetic Parallelism &#8212; the second line advances the first</strong></p>
<p>
The second line does not restate or contrast &#8212; it extends. It carries the thought forward, adds a result, specifies a location, or completes what the first line opened.
</p>
<blockquote>
<em>&#8220;I cried aloud to the LORD, /<br>
and he answered me from his holy hill.&#8221;</em><br>
<small>Psalm 3:4</small>
</blockquote>
<p>
The first line states the action: David cried out. The second line states what followed: God answered, from a specific place. It is not restating; it is completing. Action and result, held in a single couplet.
</p>
<blockquote>
<em>&#8220;O LORD, in the morning you hear my voice; /<br>
in the morning I prepare a sacrifice for you and watch.&#8221;</em><br>
<small>Psalm 5:3</small>
</blockquote>
<p>
God hears David&#8217;s voice in the morning (first line). David prepares and watches in the morning (second line). The second line specifies what the prayer looks like &#8212; arranged like a sacrifice, offered in faith, followed by watchful waiting. The first line is the covenant claim; the second line is the discipline that flows from it.
</p>
<hr>
<p><strong>The Rule for Reading</strong></p>
<p>
When a psalm line appears to say the same thing twice, do not skip the second line. Ask: <em>what is the second line doing to the first?</em>
</p>
<ul>
<li>If it restates with different words &#8212; it is intensifying. Dwell in it.</li>
<li>If it contrasts &#8212; the meaning lives in the gap between the two halves. Read them together.</li>
<li>If it extends or completes &#8212; the second line is the answer, the result, or the specification the first line pointed toward.</li>
</ul>
<p>
Hebrew poetry does not waste lines. The Holy Spirit chose this form, through these human authors, because poetry compresses more meaning into fewer words than prose can. A psalm couplet is not two ideas &#8212; it is one idea seen from two angles simultaneously. That is why the psalms reward slow reading. That is also why parallelism survives translation better than the sound-based devices of most ancient poetry: its meaning lives in the structure of the lines, not in the sound of the words.
</p>
<hr>
<p><strong>Acrostic Psalms</strong></p>
<p>
Several psalms are written as <span class="tooltip">acrostics<span class="tooltiptext"><em>AK-roh-stik</em><br>A poem in which each line or section begins with successive letters of the alphabet. In Hebrew, the aleph-bet has 22 letters. An acrostic psalm works through all 22, with each verse or stanza beginning with the next letter in order. The form itself carries theological weight &#8212; it signals comprehensiveness: from A to Z, everything that can be said on this subject has been said.</span></span> &#8212; poems structured so that each verse or stanza begins with the next letter of the Hebrew <span class="tooltip">aleph-bet<span class="tooltiptext">The Hebrew alphabet, consisting of 22 consonants. The name comes from the first two letters: <em>aleph</em> (<span class="hebrew-text" dir="rtl">&#x05D0;</span>) and <em>bet</em> (<span class="hebrew-text" dir="rtl">&#x05D1;</span>). Hebrew is written right to left.</span></span> in sequence. Psalm 119 is the most extensive in Scripture: 176 verses, divided into 22 stanzas of 8 verses each, one stanza per Hebrew letter, every verse within each stanza beginning with the same letter.
</p>
<p>
The form is not a literary game. An acrostic declares: <em>everything that can be said is being said</em> &#8212; A to Z, beginning to end, nothing withheld. Psalm 119 puts the form to its fullest use, praising God&#8217;s Word as perfect, sufficient, and delightful. The structure is the argument: no part of God&#8217;s Word is left unsaid. These acrostic patterns are entirely invisible in English translation but are part of the original text.
</p>
<p><small>Other acrostic psalms: 9&#8211;10 (which together form a single acrostic), 25, 34, 37, 111, 112, 145.</small></p>
<hr>
<p><small>Further reading: Robert Alter, <em>The Book of Psalms: A Translation with Commentary</em> (2007). Alter&#8217;s work on parallelism is the most precise English-language treatment of Hebrew poetic structure in the Psalter. His translation preserves the line structure of the Hebrew more faithfully than most English versions and is worth reading alongside this study.</small></p>
</details>
<details class="study-section">
<summary>Musical Terms and Superscriptions</summary>
<p>
Most psalms open with a heading &#8212; a line set above the text containing information about authorship, historical occasion, genre, or performance instructions. These <span class="tooltip">superscriptions<span class="tooltiptext">From the Latin <em>superscriptio</em> &#8212; &#8220;written above.&#8221; The Hebrew titles that appear at the head of 116 of the 150 psalms, containing information about authorship, musical instructions, historical occasion, or genre &#8212; for example, &#8220;A Psalm of David, when he fled from Absalom his son&#8221; (Psalm 3), or &#8220;To the choirmaster, with stringed instruments&#8221; (Psalm 4). They are part of the Masoretic Text &#8212; the authoritative Hebrew Bible &#8212; and are treated as canonical by both Jewish and Christian tradition, though sometimes printed in smaller type or set apart from the psalm body in modern editions.</span></span> are part of the canonical Scripture. Some of their terms are straightforward. Others have uncertain meanings &#8212; words that appear rarely in Scripture and whose exact sense has been debated for centuries. That uncertainty is itself significant: it confirms that the Psalms were living liturgical documents, composed and used in a musical tradition that no longer survives intact.
</p>
<hr>
<p><strong>&#8220;To the choirmaster&#8221; &#8212; <span class="hebrew-text" dir="rtl">לַמְנַצֵּחַ</span> (<em>lamnatzeach</em>)</strong></p>
<p>
Appears in 55 psalm superscriptions. The root <span class="hebrew-text" dir="rtl">נָצַח</span> (<em>natzach</em>) carries the sense of overseeing or directing &#8212; the &#8220;chief musician&#8221; or &#8220;director of music&#8221; responsible for temple worship. Psalms marked this way were designated for public, corporate performance under musical leadership. They were not private compositions &#8212; they were prepared for the congregation.
</p>
<hr>
<p><strong>&#8220;A Psalm of David&#8221; &#8212; <span class="hebrew-text" dir="rtl">מִזְמוֹר לְדָוִד</span> (<em>mizmor l&#8217;David</em>)</strong></p>
<p>
<em>Mizmor</em> &#8212; a song performed with stringed accompaniment. The preposition <em>l&#8217;</em> can mean &#8220;of&#8221; (by David), &#8220;for&#8221; (dedicated to David), or &#8220;in the style of&#8221; (in the Davidic tradition). <span class="cite-anchor" id="cite-intro-17">The majority usage across the Psalter and the New Testament&#8217;s own attribution support reading these as psalms David wrote.<sup class="ref"><a href="#ref-intro-17">[17]</a></sup></span> 73 psalms carry this heading.
</p>
<hr>
<p><strong>Selah &#8212; <span class="hebrew-text" dir="rtl">סֶלָה</span> (<em>selah</em>, pronounced <em>SEE-lah</em>)</strong></p>
<p>
Appears 71 times &#8212; not in superscriptions but embedded within the psalm texts themselves. Its exact meaning is unknown. It does not appear elsewhere in the Hebrew Bible with enough context to settle its sense. The leading proposals:
</p>
<ul style="display:flex;flex-direction:column;gap:0.75em;">
<li><strong>A musical interlude</strong> &#8212; a signal for instruments to play while singers pause. The most widely held view. The <span class="tooltip">Septuagint<span class="tooltiptext"><em>SEP-tyoo-uh-jint</em><br>The Greek translation of the Hebrew Old Testament, produced in Alexandria between the 3rd and 1st centuries BC. Abbreviated LXX. The Septuagint was the Bible of the early Church and the Old Testament quoted most often by the New Testament authors.</span></span> translates <em>selah</em> as <em>diapsalma</em> &#8212; &#8220;instrumental interlude.&#8221;</li>
<li><strong>A call to lift the voice</strong> &#8212; from the root <span class="hebrew-text" dir="rtl">סָלַל</span> (<em>salal</em>), to lift up or exalt. An instruction to sing with greater volume or intensity at that moment.</li>
<li><strong>A pause for reflection</strong> &#8212; a liturgical signal to stop and consider what was just sung before continuing.</li>
</ul>
<p>
Whatever its precise function, <em>selah</em> tends to appear at a theologically weighted moment &#8212; after a confession of trust, after a statement of God&#8217;s faithfulness, after a sharp turn in the psalm&#8217;s argument. It is rarely incidental. When a reader encounters <em>selah</em>, the appropriate response is to stop, re-read the line before it, and let it land. That pause is likely the effect <em>selah</em> was designed to produce.
</p>
<hr>
<p><strong>Maskil &#8212; <span class="hebrew-text" dir="rtl">מַשְׂכִּיל</span> (<em>maskil</em>, pronounced <em>MAS-keel</em>)</strong></p>
<p>
Appears in 13 superscriptions: Psalms 32, 42, 44, 45, 52&#8211;55, 74, 78, 88, 89, 142. From the root <span class="hebrew-text" dir="rtl">שָׂכַל</span> (<em>sakal</em>) &#8212; to have insight, to be wise, to act prudently. The term likely designates a psalm of instruction or a &#8220;skillfully composed&#8221; poem &#8212; one written with particular literary care, intended to impart understanding. Several of the most theologically dense psalms in the Psalter carry this heading.
</p>
<hr>
<p><strong>Miktam &#8212; <span class="hebrew-text" dir="rtl">מִכְתָּם</span> (<em>miktam</em>, pronounced <em>MIK-tam</em>)</strong></p>
<p>
Appears in 6 superscriptions, all Davidic: Psalms 16, 56, 57, 58, 59, 60. Meaning uncertain. Proposals include &#8220;inscription&#8221; (a poem meant to be engraved or fixed permanently), &#8220;atonement poem,&#8221; or a term for a specific musical style or register. All six psalms deal with situations of danger, deliverance, and trust in God&#8217;s faithfulness under threat.
</p>
<hr>
<p><strong>Shiggaion &#8212; <span class="hebrew-text" dir="rtl">שִׁגָּיוֹן</span> (<em>shiggayon</em>, pronounced <em>shig-AY-on</em>)</strong></p>
<p>
Appears only in Psalm 7&#8217;s superscription and in Habakkuk 3:1. Likely related to the root <span class="hebrew-text" dir="rtl">שָׁגָה</span> (<em>shagah</em>) &#8212; to wander or reel. Most scholars take it to indicate an irregular, passionate meter &#8212; a poem that does not follow a fixed rhythmic pattern, reflecting intense emotional agitation. Psalm 7 is a prayer under false accusation, and the form may mirror the distress of its content.
</p>
<hr>
<p><strong>Instrument and tune designations</strong></p>
<p>
Several superscriptions specify the instruments that accompanied a psalm. <em>Neginoth</em> (<span class="hebrew-text" dir="rtl">נְגִינוֹת</span>) &#8212; stringed instruments (Psalms 4, 6, 54, 55, 67, 76). <em>Nehiloth</em> (<span class="hebrew-text" dir="rtl">נְחִילוֹת</span>) &#8212; likely wind instruments or flutes (Psalm 5 only). <em>Gittith</em> (<span class="hebrew-text" dir="rtl">גִּתִּית</span>) &#8212; possibly an instrument associated with the town of Gath, or a vintage melody (Psalms 8, 81, 84). Others specify a named tune: &#8220;The Doe of the Dawn&#8221; (Psalm 22), &#8220;Do Not Destroy&#8221; (Psalms 57&#8211;59, 75), &#8220;The Lily&#8221; (Psalms 45, 69). These were apparently well-known melodies to which psalm texts were set &#8212; the way a modern hymnal carries a tune name alongside the words. The melodies are lost.
</p>
</details>
</details>
<details class="group-accordion">
...
<p>
The Psalms return to the same handful of words again and again &#8212; not because the poets lacked vocabulary, but because these words carry the weight of Israel&#8217;s entire relationship with God. Recognizing them on sight, and hearing the Hebrew behind them, changes what a familiar line can say. The terms below are grouped by what they describe rather than listed alphabetically.
</p>
<hr>
<p><strong>God&#8217;s Covenant Character</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Steadfast love</strong> &#8212; <span class="tooltip">chesed<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D7;&#x05B6;&#x05E1;&#x05B6;&#x05D3;</span> <span class="transliteration">(chesed)</span></span><span class="definition-list">God&#8217;s covenant loyalty &#8212; a committed, faithful love, merciful and unearned, flowing from God&#8217;s own character rather than the recipient&#8217;s merit.</span></span></span>. Already explored in the Psalm 6 verse notes; arguably the single most important word in the Psalter&#8217;s vocabulary of grace.</li>
<li><strong>Steadfast love and faithfulness</strong> &#8212; <span class="tooltip">chesed ve&#8217;emet<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D7;&#x05B6;&#x05E1;&#x05B6;&#x05D3; &#x05D5;&#x05B6;&#x05D0;&#x05B1;&#x05DE;&#x05B6;&#x05EA;</span> <span class="transliteration">(chesed ve&#8217;emet)</span></span><span class="definition-list">A fixed word-pair naming God&#8217;s reliability from two angles at once.</span></span></span>, a fixed pair appearing throughout the Psalter (25:10; 40:11; 57:3; 61:7; 85:10; 89:14). <em>Chesed</em> is the commitment that does not depend on merit; <em>emet</em> is the truthfulness that does not waver. The pair is synonymous parallelism compressed into a single phrase.</li>
<li><strong>Faithfulness</strong> &#8212; <span class="tooltip">emunah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D0;&#x05B1;&#x05DE;&#x05D5;&#x05E0;&#x05B8;&#x05D4;</span> <span class="transliteration">(emunah)</span></span><span class="definition-list">From the same root as &#8220;Amen&#8221; &#8212; reliability, steadiness.</span></span></span> &#8212; God&#8217;s reliability; He does not go back on His word (Ps 36:5). The ground for trusting His promises when circumstances argue otherwise.</li>
<li><strong>Mercy</strong> &#8212; <span class="tooltip">rachamim<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E8;&#x05B7;&#x05D7;&#x05B2;&#x05DE;&#x05B4;&#x05D9;&#x05DD;</span> <span class="transliteration">(rachamim)</span></span><span class="definition-list">Related to <em>rechem</em>, &#8220;womb&#8221; &#8212; visceral, parental compassion.</span></span></span> &#8212; distinct from <em>chesed</em>&#8217;s covenant-loyalty sense, this is mercy grounded in compassion, the way a parent feels toward a child (Ps 103:13).</li>
<li><strong>Gracious</strong> &#8212; <span class="tooltip">channun<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D7;&#x05B7;&#x05E0;&#x05BC;&#x05D5;&#x05E0;</span> <span class="transliteration">(channun)</span></span><span class="definition-list">Disposed to give favor that is not earned.</span></span></span> &#8212; frequently paired with &#8220;merciful&#8221; in the liturgical formula drawn from Exodus 34:6, echoed throughout the Psalter (86:15; 103:8; 145:8).</li>
<li><strong>For Your name&#8217;s sake</strong> &#8212; <span class="tooltip">l&#8217;ma&#8217;an shemekha<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05DC;&#x05B0;&#x05DE;&#x05B7;&#x05E2;&#x05B2;&#x05DF; &#x05E9;&#x05B0;&#x05DE;&#x05B6;&#x05DA;</span> <span class="transliteration">(l&#8217;ma&#8217;an shemekha)</span></span><span class="definition-list">An appeal to God&#8217;s own reputation, not the petitioner&#8217;s merit.</span></span></span> &#8212; when David prays this way (23:3; 25:11; 143:11), he is not bargaining; he is asking God to be faithful to who He has already revealed Himself to be.</li>
<li><strong>Name</strong> &#8212; <span class="tooltip">shem<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E9;&#x05B5;&#x05DD;</span> <span class="transliteration">(shem)</span></span><span class="definition-list">Not a label, but the sum of revealed character and reputation.</span></span></span> &#8212; to praise God&#8217;s name (8:1) or trust in it (33:21) is to engage with who God has shown Himself to be, not merely to use a word.</li>
</ul>
<hr>
<p><strong>Power, Protection, and Royal Imagery</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Arm</strong> &#8212; <span class="tooltip">zeroa<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D6;&#x05B0;&#x05E8;&#x05D5;&#x05B9;&#x05E2;</span> <span class="transliteration">(zeroa)</span></span><span class="definition-list">Strength exercised in action.</span></span></span> &#8212; the standard image for power deployed, especially in deliverance: &#8220;with your mighty arm&#8221; (77:15).</li>
<li><strong>Hand</strong> &#8212; <span class="tooltip">yad<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D9;&#x05B8;&#x05D3;</span> <span class="transliteration">(yad)</span></span><span class="definition-list">Active power and personal involvement.</span></span></span> &#8212; to fall &#8220;into His hand&#8221; (31:5) is to be under God&#8217;s direct care or judgment, depending on context.</li>
<li><strong>Right hand</strong> &#8212; <span class="tooltip">yamin<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D9;&#x05B8;&#x05DE;&#x05B4;&#x05D9;&#x05DF;</span> <span class="transliteration">(yamin)</span></span><span class="definition-list">The place of favor, strength, and shared authority.</span></span></span> &#8212; to sit at someone&#8217;s right hand is to share their honor (16:11; 110:1).</li>
<li><strong>Horn</strong> &#8212; <span class="tooltip">qeren<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E7;&#x05B6;&#x05E8;&#x05B6;&#x05DF;</span> <span class="transliteration">(qeren)</span></span><span class="definition-list">Drawn from a horned animal&#8217;s strength &#8212; a fixed metaphor for power and dignity.</span></span></span> &#8212; &#8220;the horn of my salvation&#8221; (18:2). To have one&#8217;s horn lifted up is to be exalted; cut off, to be humiliated (89:17).</li>
<li><strong>Rock</strong> &#8212; <span class="tooltip">tsur<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E6;&#x05D5;&#x05E8;</span> <span class="transliteration">(tsur)</span></span><span class="definition-list">An immovable place of refuge.</span></span></span> &#8212; one of the Psalter&#8217;s most frequent divine titles (18:2; 62:7). Unlike a fortress built by human hands, the Rock was already there before anyone took shelter in it.</li>
<li><strong>Upholds</strong> &#8212; <span class="tooltip">samakh<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E1;&#x05B8;&#x05DE;&#x05B7;&#x05DA;</span> <span class="transliteration">(samakh)</span></span><span class="definition-list">A hand braced under a falling weight.</span></span></span> &#8212; God sustaining what would otherwise fall (37:24; 145:14) &#8212; not sympathy from a distance, but active support.</li>
</ul>
<hr>
<p><strong>Worship and the Gathered People</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Bless</strong> &#8212; <span class="tooltip">barakh<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D1;&#x05BC;&#x05B5;&#x05E8;&#x05B5;&#x05DA;</span> <span class="transliteration">(barakh)</span></span><span class="definition-list">Shares a root with &#8220;knee&#8221; &#8212; to bend in praise.</span></span></span> &#8212; runs in both directions: God blesses His people with favor, and His people bless Him back in praise (&#8220;Bless the LORD, O my soul,&#8221; 103:1).</li>
<li><strong>Blessed</strong> &#8212; <span class="tooltip">barukh<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D1;&#x05BC;&#x05B8;&#x05E8;&#x05D5;&#x05DA;</span> <span class="transliteration">(barukh)</span></span><span class="definition-list">The passive form &#8212; a settled, objective state of favor.</span></span></span> &#8212; opens Psalm 1 and closes Psalm 2 (2:12); names a state before God, not a felt emotion.</li>
<li><strong>Praise the LORD</strong> &#8212; <span class="tooltip">halleluyah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D4;ַ&#x05DC;&#x05BC;&#x05B0;&#x05DC;&#x05D5;&#x05BC;&#x05D9;&#x05B8;&#x05D4;</span> <span class="transliteration">(hallelu-Yah)</span></span><span class="definition-list">An imperative plural &#8212; a summons to others to join in praise.</span></span></span> &#8212; not a description but a command, addressed corporately; the shortened divine name <em>Yah</em> sits inside the word itself.</li>
<li><strong>New song</strong> &#8212; <em>shir chadash</em> (&#x05E9;&#x05B4;&#x05D9;&#x05E8; &#x05D7;&#x05B8;&#x05D3;&#x05B8;&#x05E9;) &#8212; opens several hymns (33:3; 96:1; 98:1; 144:9), marking a fresh act of God&#8217;s deliverance met with fresh words, not just repetition of the old ones.</li>
<li><strong>Courts of the LORD</strong> &#8212; <em>chatsrot</em> (&#x05D7;&#x05B7;&#x05E6;&#x05B0;&#x05E8;&#x05D5;&#x05BA;&#x05EA;) &#8212; the open enclosures of the Temple precincts, the place of access to God&#8217;s presence among His gathered people (84:2, 10; 100:4). Desire for the courts is desire for nearness to God, not merely the building.</li>
<li><strong>Great congregation</strong> &#8212; <em>qahal rav</em> (&#x05E7;&#x05B8;&#x05D4;&#x05B8;&#x05DC; &#x05E8;&#x05B8;&#x05D1;) &#8212; the full gathered assembly of Israel at worship (22:25; 35:18). Praise given &#8220;in the great congregation&#8221; is given publicly, before the whole covenant community.</li>
<li><strong>Presence</strong> &#8212; <span class="tooltip">panim<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E4;&#x05B8;&#x05E0;&#x05B4;&#x05D9;&#x05DD;</span> <span class="transliteration">(panim)</span></span><span class="definition-list">Literally &#8220;face&#8221; &#8212; relational, not merely positional.</span></span></span> &#8212; to seek God&#8217;s &#8220;face&#8221; (27:8) is to seek personal access to Him; to have Him &#8220;hide His face&#8221; (13:1) is to feel His absence, whether or not His character has changed.</li>
<li><strong>Zion</strong> &#8212; <span class="tooltip">Tsiyyon<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E6;&#x05B4;&#x05D9&#x05BC;&#x05D5;&#x05B9;&#x05DF;</span> <span class="transliteration">(Tsiyyon)</span></span><span class="definition-list">David&#8217;s captured fortress, later the Temple mount and the whole reality of God dwelling among His people.</span></span></span> (2 Samuel 5:7; Ps 48:1&#8211;2; 132:13). In the Christological layer, Zion&#8217;s role as God&#8217;s dwelling place anticipates Christ, in whom God dwells among His people fully. <small>John 1:14</small></li>
</ul>
<hr>
<p><strong>Devotion and the Inner Life</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Seek</strong> &#8212; <em>darash</em> / <em>biqqesh</em> (&#x05D3;&#x05B8;&#x05E8;&#x05B7;&#x05E9; / &#x05D1;&#x05B4;&#x05BC;&#x05E7;&#x05BC;&#x05E9;) &#8212; to actively pursue God rather than passively wait, in worship (27:8) or in crisis (105:4). Seeking assumes God is found by those who pursue Him in earnest.</li>
<li><strong>Call</strong> &#8212; <span class="tooltip">qara<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E7;&#x05B8;&#x05E8;&#x05B8;&#x05D0;</span> <span class="transliteration">(qara)</span></span><span class="definition-list">To address God directly, expecting Him to hear.</span></span></span> &#8212; carries the same directness as calling out a person&#8217;s name in a crowd (18:3; 116:4).</li>
<li><strong>Remember</strong> &#8212; <span class="tooltip">zakhar<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D6;&#x05B8;&#x05DB;&#x05B7;&#x05E8;</span> <span class="transliteration">(zakhar)</span></span><span class="definition-list">Never mere mental recall &#8212; an act that moves toward response.</span></span></span> &#8212; when the psalmist asks God to &#8220;remember&#8221; His covenant (25:6; 74:2; 89:47), he is asking God to act on a commitment, not recall a forgotten fact.</li>
<li><strong>Meditate</strong> &#8212; <span class="tooltip">hagah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D4;&#x05B8;&#x05D2;&#x05B8;&#x05D4</span> <span class="transliteration">(hagah)</span></span><span class="definition-list">Literally to murmur, mutter, or growl.</span></span></span> &#8212; opens Psalm 1:2; likely describes reading Scripture aloud in a low voice, repeating it until it shaped the reader from the inside.</li>
<li><strong>Fear (of the LORD)</strong> &#8212; <span class="tooltip">yir&#8217;ah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D9;&#x05B4;&#x05E8;&#x05B0;&#x05D0;&#x05B8;&#x05D4</span> <span class="transliteration">(yir&#8217;ah)</span></span><span class="definition-list">Not terror, but reverent awe that orders a whole life.</span></span></span> &#8212; the precondition for wisdom, not its opposite (111:10; 112:1).</li>
</ul>
<hr>
<p><strong>Justice and the Way of Life</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Just / Justice</strong> &#8212; <span class="tooltip">mishpat<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05DE;&#x05B4;&#x05E9;&#x05B0;&#x05E4;&#x05B8;&#x05D0;</span> <span class="transliteration">(mishpat)</span></span><span class="definition-list">Judging rightly, giving each party what is due.</span></span></span> &#8212; especially in defense of the powerless (9:8; 72:1&#8211;2; 146:7). Paired with righteousness so often that the two function as nearly one idea.</li>
<li><strong>Righteous</strong> &#8212; <span class="tooltip">tsaddiq<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E6;&#x05B7;&#x05D3;&#x05BC;&#x05B4;&#x05D9;&#x05E7;</span> <span class="transliteration">(tsaddiq)</span></span><span class="definition-list">One who meets the standard of what is right in relationship.</span></span></span> &#8212; Psalm 1 frames the entire Psalter around the contrast between the righteous and the wicked (1:6).</li>
<li><strong>Righteousness</strong> &#8212; <span class="tooltip">tsedeq / tsedaqah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E6;&#x05B6;&#x05D3;&#x05B6;&#x05E7; / &#x05E6;&#x05B0;&#x05D3;&#x05B8;&#x05E7;&#x05B8;&#x05D4</span> <span class="transliteration">(tsedeq / tsedaqah)</span></span><span class="definition-list">Applied to God&#8217;s character, His acts of deliverance, and the standard His people are measured by.</span></span></span> (11:7; 71:15). In the Christological layer, the righteousness the Psalms demand and the righteousness Christ provides are the same righteousness, met from opposite directions &#8212; Law and Gospel converging on a single word.</li>
<li><strong>Paths</strong> &#8212; <em>ma&#8217;gal</em> (&#x05DE;&#x05B7;&#x05E2;&#x05B0;&#x05D2;&#x05B8;&#x05DC;) &#8212; the worn tracks a traveler follows; &#8220;paths of righteousness&#8221; (23:3) is not an abstraction but a concrete, walkable way of life.</li>
<li><strong>Ways</strong> &#8212; <span class="tooltip">derekh<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D3;&#x05B6;&#x05E8;&#x05B6;&#x05DA;</span> <span class="transliteration">(derekh)</span></span><span class="definition-list">A person&#8217;s whole manner of life, the road they are actually on.</span></span></span> &#8212; to ask God to &#8220;teach me your ways&#8221; (25:4) is to ask for a life reoriented at the level of direction, not just isolated decisions.</li>
</ul>
<hr>
<p><strong>Deliverance and Rescue</strong></p>
<ul style="display:flex;flex-direction:column;gap:0.6em;">
<li><strong>Deliver</strong> &#8212; <span class="tooltip">natsal<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05E0;&#x05B7;&#x05E6;&#x05B7;&#x05DC;</span> <span class="transliteration">(natsal)</span></span><span class="definition-list">To be snatched out of immediate danger.</span></span></span> &#8212; used most often of rescue from specific threats: enemies, sickness, the grave (6:4; 7:1; 31:15).</li>
<li><strong>Redeem</strong> &#8212; <span class="tooltip">ga&#8217;al<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D2;&#x05B8;&#x05D0;&#x05B7;&#x05DC;</span> <span class="transliteration">(ga&#8217;al)</span></span><span class="definition-list">A kinsman&#8217;s legal duty to buy back a relative&#8217;s land, freedom, or life (cf. Ruth 4).</span></span></span> &#8212; applied to God, it casts His deliverance as a Redeemer-kinsman&#8217;s rightful reclaiming of what belongs to Him (19:14; 49:15; 130:8).</li>
<li><strong>Salvation</strong> &#8212; <span class="tooltip">yeshu&#8217;ah<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D9;&#x05B0;&#x05E9;&#x05D5;&#x05B0;&#x05E2;&#x05B8;&#x05D4</span> <span class="transliteration">(yeshu&#8217;ah)</span></span><span class="definition-list">Same root as the name <em>Joshua</em> &#8212; and, in Greek, <em>Jesus</em>.</span></span></span> &#8212; deliverance that is total: rescue from danger and restoration to wholeness together (3:8; 27:1).</li>
<li><strong>Saints</strong> &#8212; <span class="tooltip">chasidim<span class="tooltiptext"><span class="hebrew-row"><span class="hebrew-text" dir="rtl">&#x05D7;&#x05B2;&#x05E1;&#x05B4;&#x05D9;&#x05D3;&#x05B4;&#x05D9;&#x05DD;</span> <span class="transliteration">(chasidim)</span></span><span class="definition-list">Literally &#8220;chesed-ones&#8221; &#8212; those bound to God by His covenant loyalty.</span></span></span> &#8212; not a claim to moral perfection but to covenant relationship; those who belong to God through His <em>chesed</em> are, by definition, His saints (30:4; 116:15).</li>
</ul>
<hr>
...
<div class="ref-list">
  <ol>
    ...
    <li id="ref-intro-8"><a href="#cite-intro-8" class="ref-back">&#x21A9;</a> Matthew 27:46 &#8212; Jesus quotes Psalm 22:1 directly (&#8220;My God, my God, why have you forsaken me?&#8221;). The Gospel writers record the rest of the crucifixion in the same psalm&#8217;s own language: Matthew 27:35 and John 19:23&#8211;24 (dividing his garments and casting lots, Psalm 22:18); Matthew 27:39&#8211;43 (mocking, &#8220;let God rescue him,&#8221; echoing Psalm 22:7&#8211;8). What David wrote of but never lived, the Gospels record Christ actually enduring.</li>
    <li id="ref-intro-9"><a href="#cite-intro-9" class="ref-back">&#x21A9;</a> Westminster Confession of Faith, Chapter VII: &#8220;Of God&#8217;s Covenant with Man&#8221; (1647) &#8212; the defining statement of Reformed covenant theology. It distinguishes the Covenant of Works (made with Adam, requiring perfect obedience) from the Covenant of Grace (administered through Christ, requiring faith). This framework organizes the entire biblical narrative under covenant categories; a psalm is read by asking which covenant it belongs to, rather than whether it kills or gives life in the Lutheran Law-Gospel sense. The Presbyterian, Dutch Reformed, and many Baptist confessions follow this structure.</li>
    <li id="ref-intro-10"><a href="#cite-intro-10" class="ref-back">&#x21A9;</a> Georges Florovsky, <em>Bible, Church, Tradition: An Eastern Orthodox View</em> (Belmont, MA: Nordland, 1972). Florovsky&#8217;s &#8220;neo-patristic synthesis&#8221; holds that Orthodox theology must be continuously renewed by return to the Fathers, and that Scripture is properly read only within the Tradition of the Church. See also the Quinisext Council (Trullo, 692 AD), Canon 19, which established that the Fathers&#8217; interpretations are normative for the Church&#8217;s reading of Scripture.</li>
    <li id="ref-intro-11"><a href="#cite-intro-11" class="ref-back">&#x21A9;</a> Compare Graeme Goldsworthy, <em>Preaching the Whole Bible as Christian Scripture</em> (Grand Rapids: Eerdmans, 2000) &#8212; who reads the entire Old Testament through a consistent Christological and typological grid &#8212; with John Goldingay, <em>Psalms</em> (Baker Commentary on the Old Testament Wisdom and Psalms, 3 vols., 2006&#8211;2008) &#8212; who reads the Psalms primarily in their historical context without systematic typological application. Both are widely used Evangelical scholars. The difference illustrates that without a binding confessional framework, Christological reading becomes a matter of individual judgment rather than hermeneutical obligation.</li>
    <li id="ref-intro-12"><a href="#cite-intro-12" class="ref-back">&#x21A9;</a> Rashi (Rabbi Shlomo Yitzchaki, 1040&#8211;1105), <em>Commentary on Psalms</em> &#8212; the most influential medieval Jewish commentator on the Hebrew Bible. Rashi consistently reads the royal and suffering psalms as referring to David&#8217;s historical circumstances or to the nation of Israel collectively. Extreme suffering language (Psalm 22&#8217;s piercing imagery, Psalm 16&#8217;s deliverance from Sheol) is read as hyperbole &#8212; the heightened register of lament poetry &#8212; or as corporate lament, the nation&#8217;s voice rather than an individual&#8217;s. See also Abraham ibn Ezra (1089&#8211;1167), whose Psalms commentary similarly anchors the language to the historical author and context rather than to messianic fulfillment.</li>
    <li id="ref-intro-13"><a href="#cite-intro-13" class="ref-back">&#x21A9;</a> <em>Dei Verbum</em> (Dogmatic Constitution on Divine Revelation), Vatican II, 1965, §9&#8211;10 &#8212; <em>&#8220;Sacred Tradition and Sacred Scripture form one sacred deposit of the word of God&#8230; The task of authentically interpreting the word of God, whether written or handed on, has been entrusted exclusively to the living teaching office of the Church.&#8221;</em> See also <em>Catechism of the Roman Catholic Church</em>, §80&#8211;83. The Roman Catholic position holds that Scripture and Tradition constitute a single source of revelation, and that the Magisterium alone has binding authority to interpret both. This differs from the Eastern Orthodox position, which also holds Tradition alongside Scripture but locates authority in Patristic consensus and Ecumenical Councils rather than in the office of Rome.</li>
    <li id="ref-intro-14"><a href="#cite-intro-14" class="ref-back">&#x21A9;</a> Hermann Gunkel, <em>Introduction to Psalms: The Genres of the Religious Lyric of Israel</em> (Macon, GA: Mercer University Press, 1998; original German 1933). Gunkel&#8217;s form-critical method classifies the Psalms by genre (lament, hymn, thanksgiving, royal, wisdom) and reads each type in light of comparable ancient Near Eastern literature. Divine authorship, Davidic superscriptions, and Christological meaning are outside the method&#8217;s scope &#8212; the psalms are read as the religious expressions of Israelite communities shaped by their historical circumstances. Gunkel&#8217;s categories remain standard in academic biblical scholarship and are widely taught in mainline Protestant seminaries.</li>
    <li id="ref-intro-15"><a href="#cite-intro-15" class="ref-back">&#x21A9;</a> New Testament citations of Psalm 69: John 2:17 (Ps 69:9 &#8212; zeal for the Temple); John 15:25 (Ps 69:4 &#8212; hated without cause); John 19:28&#8211;29 (Ps 69:21 &#8212; vinegar given to drink); Romans 11:9&#8211;10 (Ps 69:22&#8211;23 &#8212; table as snare); Romans 15:3 (Ps 69:9 &#8212; insults fell on Christ); Acts 1:20 (Ps 69:25 &#8212; his place made desolate, applied to Judas). Six distinct citations, drawn from both the mercy and the judgment portions of the same psalm. The apostles treated Psalm 69 as a unified prophecy of Christ, not selecting only the comfortable verses.</li>
    <li id="ref-intro-16"><a href="#cite-intro-16" class="ref-back">&#x21A9;</a> Martin Luther, <em>First Lectures on the Psalms</em> (<em>Dictata super Psalterium</em>, 1513&#8211;1515), in <em>Luther&#8217;s Works</em>, Vol. 10: <em>Psalms 1&#8211;75</em> and Vol. 11: <em>Psalms 76&#8211;126</em> (St. Louis: Concordia, 1974&#8211;1976). See also <em>Operationes in Psalmos</em> (1519&#8211;1521), partially translated in <em>Luther&#8217;s Works</em>, Vol. 14. In both works Luther consistently interprets the imprecatory psalms through a Christological frame: the one crying out for judgment is ultimately Christ, in whom the Church prays. The psalms of vengeance are not expressions of personal malice but the just complaint of Christ and His Body against sin, death, and the devil &#8212; a complaint that will be answered on the Last Day.</li>
    <li id="ref-intro-17"><a href="#cite-intro-17" class="ref-back">&#x21A9;</a> Matthew 22:43 &#8212; Jesus asks the Pharisees how David, &#8220;in the Spirit,&#8221; calls the Messiah &#8220;Lord,&#8221; quoting Psalm 110:1 and treating David as its author. Acts 2:25 &#8212; Peter introduces his quotation of Psalm 16 by naming David directly as its speaker: &#8220;For David says concerning him&#8230;&#8221;</li>
  </ol>
</div>
</details>
</details>
...
<p>
<em>Doing good works is not the same as being known by Him.</em> Good works are not just good deeds &#8212; they flow from already being known by God, through faith in Christ. The wicked can do outwardly good deeds too, but apart from that same union with Christ, their deeds are not good works; their way still perishes regardless. If you are joined to Christ, God already <span class="tooltip">knows<span class="tooltiptext">Hebrew <span class="hebrew-text" dir="rtl">יָדַע</span> (yada) &#8212; more than information; the same relational sense is used of God's covenant people in Amos 3:2, "You only have I known of all the families of the earth" &#8212; election and care, not mere awareness.</span></span> you and calls you secure &#8212; bring every doubt about that to Him honestly, and rest in what He has already declared true of you in His Son.
</p>
...
<p>
<em>Submit to the King now, rather than joining the rebellion.</em> Later in the psalm, the warning comes first: <span id="cite-9" class="cite-anchor">&#8220;his wrath is quickly kindled,&#8221; and to delay is to risk perishing.<sup class="ref"><a href="#ref-9">[9]</a></sup></span> Then comes the actual invitation: <span id="cite-10" class="cite-anchor">&#8220;Blessed are all who take refuge in him.&#8221;<sup class="ref"><a href="#ref-10">[10]</a></sup></span> Bow to Him today, and that blessing is yours.
</p>
...
<p>
Tearing the bonds loose is not enough for them &#8212; they throw the cords away entirely, leaving no trace of the restraint behind. <span id="cite-1" class="cite-anchor">Bonds and cords were the ordinary language of a <span class="tooltip">vassal kingdom's<span class="tooltiptext">A smaller kingdom bound by treaty to serve and pay tribute to a stronger ruling power, in exchange for protection &#8212; not independent, but subordinate to its overlord.</span></span> obligations to its overlord &#8212; casting them off pictures a declared, outright independence, not just resistance to one demand.<sup class="ref"><a href="#ref-1">[1]</a></sup></span>
</p>
...
<p>
<span id="cite-2" class="cite-anchor">This same phrase &#8212; "burst their bonds apart" &#8212; describes the opposite situation elsewhere in the Psalter. Psalm 107 tells of people bound in hard labor because they had rebelled against God's words and spurned His counsel; only when they cried out to Him did the LORD Himself burst their bonds apart.<sup class="ref"><a href="#ref-2">[2]</a></sup></span> The kings and rulers seize that same freedom-language for the opposite purpose: not calling out to God for release, but declaring their own release from Him.
</p>

<p>
<span id="cite-3" class="cite-anchor">They have liberty and bondage backwards: God's rule is itself liberty; what they call freedom is the real bondage.<sup class="ref"><a href="#ref-3">[3]</a></sup></span>
</p>
...
<p>
<em>Name what you've stopped calling a command.</em> <span id="cite-7" class="cite-anchor">The kings and rulers cast off God's rule over them here &#8212; a rule that takes the form of command: turning from evil, and doing good.<sup class="ref"><a href="#ref-7">[7]</a></sup></span> Is there a sin you've stopped calling sin? <span id="cite-8" class="cite-anchor">Repent and turn back &#8212; a relabeled sin is still a sin.<sup class="ref"><a href="#ref-8">[8]</a></sup></span> Is there a good you know to do and keep leaving undone? <span id="cite-9" class="cite-anchor">That delay is sin, not harmless at all &#8212; do what you know to do.<sup class="ref"><a href="#ref-9">[9]</a></sup></span> <span id="cite-10" class="cite-anchor">Pray for the desire and the ability to follow through &#8212; both are God's to give, not yours to produce.<sup class="ref"><a href="#ref-10">[10]</a></sup></span> <span id="cite-11" class="cite-anchor">And when you fail &#8212; because you will &#8212; don't hide or explain away that failure; look to Christ for forgiveness instead.<sup class="ref"><a href="#ref-11">[11]</a></sup></span>
</p>

<p>
<em>Sincerity isn't proof.</em> <span id="cite-12" class="cite-anchor">These rebels rejected God's Anointed while believing they were acting for His own <span class="tooltip">glory<span class="tooltiptext">God's own honor and worth, rightly recognized. Honoring the Father can't be separated from honoring the Son He sent (John 5:23) &#8212; real devotion to one always includes the other.</span></span>.<sup class="ref"><a href="#ref-12">[12]</a></sup></span> You can sincerely believe you're serving Him and still be rejecting God. Ask whether some part of God's Word you don't keep is rejection, relabeled in your own mind as <span class="tooltip">devotion<span class="tooltiptext">Real devotion to God shows itself in obedience, not just in feeling: "If you love me, you will keep my commandments" (John 14:15).</span></span>.
</p>

<p>
<em>Notice when a feeling becomes a choice.</em> The kings and rulers in this psalm move from a private resolve here in verse 3 to a spoken allegiance at the cross: "We have no king but Caesar." <span id="cite-13" class="cite-anchor">The same shift from private resolve to spoken allegiance can happen in your own life without you noticing &#8212; a private resentment toward one of God's commands hardening into a pattern, relationship, or habit built around avoiding that command.<sup class="ref"><a href="#ref-13">[13]</a></sup></span> <span id="cite-14" class="cite-anchor">Ask God to search you and reveal what that is for you, if anything.<sup class="ref"><a href="#ref-14">[14]</a></sup></span>
</p>

<p>
<em>Bring your failures to the King who frees.</em> Every one of these &#8212; the obedience left undone, the rejection relabeled as devotion, the private resentment becoming a habit &#8212; is exactly the bondage this psalm's rebels mistake for <span class="tooltip">freedom<span class="tooltiptext">Not permission to do as you please, but release from slavery to sin, given only by Christ.</span></span>. Christ, the very King these rebels rejected, is also the only one who frees anyone from that bondage: <span id="cite-15" class="cite-anchor">"if the Son sets you free, you will be free indeed."<sup class="ref"><a href="#ref-15">[15]</a></sup></span> Bring these to Him in prayer &#8212; freedom is His to give.
</p>
...
<div class="ref-list">
  <ol>
    <li id="ref-1"><a href="#cite-1" class="ref-back">&#8617;</a> <em>The Lutheran Study Bible</em> (Concordia Publishing House), note on Psalm 2:3: "cast away their cords. Pictures independence sought by vassal kingdoms."</li>
    <li id="ref-2"><a href="#cite-2" class="ref-back">&#8617;</a> Psalm 107:10-14 (ESV): "Some sat in darkness and in the shadow of death, prisoners in affliction and in irons, for they had rebelled against the words of God, and spurned the counsel of the Most High... Then they cried to the LORD in their trouble, and he delivered them from their distress. He brought them out of darkness and the shadow of death, and burst their bonds apart."</li>
    <li id="ref-3"><a href="#cite-3" class="ref-back">&#8617;</a> Martin Luther, <em>Operationes in Psalmos</em> (1519-21), on Psalm 2:3: "Thus they call the law of Christ, which is the law of liberty and sweetness, 'bands' and a 'yoke'... but, on the other hand, they believe their own law, which is in truth a bondage and state of labour, to be liberty and sweetness." Verified against the primary-source English translation (Henry Cole, <em>Luther's Commentary on the First Twenty-Two Psalms</em>). Cf. James 1:25 (ESV): "the perfect law, the law of liberty."</li>
    <li id="ref-4"><a href="#cite-4" class="ref-back">&#8617;</a> Galatians 5:16-17 (ESV): "But I say, walk by the Spirit, and you will not gratify the desires of the flesh. For the desires of the flesh are against the Spirit, and the desires of the Spirit are against the flesh, for these are opposed to each other, to keep you from doing the things you want to do." Even someone joined to Christ still feels the pull to escape His rule &#8212; the flesh's desire does not end at conversion, only its verdict.</li>
    <li id="ref-5"><a href="#cite-5" class="ref-back">&#8617;</a> 1 Kings 12:4, 16, 19 (ESV): "Your father made our yoke heavy... 'What portion do we have in David? We have no inheritance in the son of Jesse. To your tents, O Israel!'... So Israel has been in rebellion against the house of David to this day."</li>
    <li id="ref-6"><a href="#cite-6" class="ref-back">&#8617;</a> John 19:14-15 (ESV): "He said to the Jews, 'Behold your King!' They cried out, 'Away with him, away with him, crucify him!' Pilate said to them, 'Shall I crucify your King?' The chief priests answered, 'We have no king but Caesar.'"</li>
    <li id="ref-7"><a href="#cite-7" class="ref-back">&#8617;</a> Martin Luther, <em>Operationes in Psalmos</em> (1519-21), on Psalm 2:3: "These 'bonds' are the commandments of Christ, by which we are taught how to walk in his way. And this 'yoke' or these 'cords' are his judgments, by which we are prohibited from doing evil." Same primary source as ref-3 (Henry Cole translation), a different passage.</li>
    <li id="ref-8"><a href="#cite-8" class="ref-back">&#8617;</a> Acts 3:19 (ESV): "Repent therefore, and turn back, that your sins may be blotted out."</li>
    <li id="ref-9"><a href="#cite-9" class="ref-back">&#8617;</a> James 4:17 (ESV): "So whoever knows the right thing to do and fails to do it, for him it is sin."</li>
    <li id="ref-10"><a href="#cite-10" class="ref-back">&#8617;</a> Philippians 2:13 (ESV): "for it is God who works in you, both to will and to work for his good pleasure."</li>
    <li id="ref-11"><a href="#cite-11" class="ref-back">&#8617;</a> 1 John 1:8-9 (ESV): "If we say we have no sin, we deceive ourselves, and the truth is not in us. If we confess our sins, he is faithful and just to forgive us our sins and to cleanse us from all unrighteousness."</li>
    <li id="ref-12"><a href="#cite-12" class="ref-back">&#8617;</a> Martin Luther, <em>Operationes in Psalmos</em> (1519-21), on Psalm 2:3: "...in rejecting Christ, they believed that they were acting for the glory of God and of his law." Same primary source as ref-3 and ref-7. Cf. John 16:2 (ESV): "...the hour is coming when whoever kills you will think he is offering service to God." Jesus predicts the same self-deceived opposition &#8212; believing themselves to serve God while acting against Him.</li>
    <li id="ref-13"><a href="#cite-13" class="ref-back">&#8617;</a> Hebrews 3:12-13 (ESV): "Take care, brothers, lest there be in any of you an evil, unbelieving heart, leading you to fall away from the living God. But exhort one another every day, as long as it is called 'today,' that none of you may be hardened by the deceitfulness of sin."</li>
    <li id="ref-14"><a href="#cite-14" class="ref-back">&#8617;</a> Psalm 139:23-24 (ESV): "Search me, O God, and know my heart! Try me and know my thoughts! And see if there be any grievous way in me, and lead me in the way everlasting!"</li>
    <li id="ref-15"><a href="#cite-15" class="ref-back">&#8617;</a> John 8:34-36 (ESV): "Everyone who practices sin is a slave to sin. The slave does not remain in the house forever; the son remains forever. So if the Son sets you free, you will be free indeed."</li>
  </ol>
</div>
<p>
  <span class="selah-marker">
...
{ label: "Psalm 3:1",
    ...
    conditionAngle: "surrounded by enemies and betrayed by his own son, yet sleeps in peace trusting God's protection",
	  ...
	  text:`
    <div class="verse-row">
      <div class="verse-num">3:1</div>
      <div class="verse-content">
        <span class="verse-indent">Save Me, O My God</span><br>
        <span class="verse-indent">O LORD, how many are my foes!</span><br>
		<span class="verse-indent">Many are rising against me;</span><br>
      </div>
    </div>
  `,

      insight: `<p> Absolam who is David's son who is now king of Isreal is building his army and names his father David an enemy.
Absolam and his people say the David will not be protected by God or saved by Him. (Most likely because of what David did to Uriah).
David says: But You oh Lord, are protecting me and keeping my status of king as vindicated.
I (David) called to the Lord, and He answered me from Mount Zion. </p> 

<p><em>The City of David and Zion</p></em>

<img src="TMAPMZ.png" alt="Mount Zion" height="300" width="auto"/>

<p> The Lord supports me (David) when I am asleep.
...
`
   ...
   { label: "Psalm 4:1",
    ...
    `,
insight: `
      <p>David is under attack (slander, opposition). His enemies are spreading lies about him, trusting in their own plans rather than recognizing David as God's chosen.
	  David contrasts their pursuit of "worthless lies" with his own trust in God's righteousness. 
	  He's confident God will vindicate him because of past faithfulness.</p>
	  
	  <p><em> David addresses his enemies</em></p>
	  
<p> Be shaken [by what I've said], but don't let it drive you to sin. Instead, reflect deeply in your 	heart when you lie down tonight, and then be still [before God]. </strong></p>

<p><em> David is essentially saying</em></p>

<p> "My rebuke should shake you up - good! Let it disturb you. But instead of reacting defensively or angrily against me, take that emotional energy and turn it inward. Tonight, when you're alone with your thoughts, honestly examine your heart. Ask yourself: 
'Am I really in the right here? Am I pursuing lies? Am I opposing God's will?' And after you've searched your heart, be quiet before God. Don't rush to defend yourself or plot your next move. Just be still. </p>

<p> Apostle Paul quotes verse 3: "Be angry and do not sin; do not let the sun go down on your anger, and give no opportunity to the devil."</p>

<p><em> Paul's application </em></p> 
...
<span class="selah-marker"><em>AMEN</em></span>
  ...
  { label: "Psalm 4:2",
    ...
    text: `
      <div class="verse-row">
        <div class="verse-num">4:2</div>
        <div class="verse-content">
          Fellow humans, how long will you slander me and attack my reputation? How long will you love worthless schemes and pursue the lie that you can succeed against God's anointed?
        </div>
      </div>
    `,
 ...
 { label: "Psalm 4:4",
    ...
    `,
    insight: `
      <p><strong>Apostle Paul quotes this verse in Ephesians 4:26:</strong> "Be angry and do not sin; do not let the sun go down on your anger, and give no opportunity to the devil."</p>
...
{ label: "Psalm 4:5",
    ...
    `,
    insight: `<p>David's instruction: STOP attacking based on lies. Come back to God genuinely with repentant hearts and right living, not just empty rituals.</p>
	<p><em> David is essentially saying: </em></p>
You've been attacking me based on lies, trusting in your own schemes. STOP. Instead, come back to God genuinely - not with empty rituals, 
but with repentant hearts and right living. Stop trusting in your ability to succeed against God's plan. Trust in the LORD instead. </p> 

<p><em> Explicit personal paraphrase with subtext: </p></em>

<p> People are asking, 'Who will show us good?' [whether in cynicism or desperation]. LORD, I'm answering that question with a prayer: Lift up the light of Your face upon us - for 
Your favor alone is the source of all true good. LORD! We need YOUR favor, YOUR presence, YOUR blessing. </p>

<p><em> David is essentially saying: </p></em>

<p> "Many people around me are asking in [discouragement or cynicism], 'Who can show us any good? Where will blessing and prosperity come from?' But LORD, I know the answer to their question - 
it's found only in You. Please lift up the light of Your face upon us - let Your favor shine on us, for Your presence and blessing are the only true good we need." </p>

<p><em> Connections: </p></em>

<p> 2 Corinthians 4:6 </p>

<p> "For God, who said, 'Let light shine out of darkness,' has shone in our hearts to give the light of the knowledge of the glory of God in the face of Jesus Christ."
In Christ, we see "the light of God's face", Jesus is the full revelation of God's favor, through Christ, God's face shines on us permanently.</p>
...
The glory we "see" in Jesus = the "light of God's face" David prayed for</p>

<p> Matthew 5:16 </p>
<p> "Let your light shine before others, so that they may see your good works and give glory to your Father who is in heaven."Believers now reflect the light of God's face to the world </p>
...
Deliver us from this body of sin and shine your face upon us. </p>`
 ...
 { label: "Psalm 4:6",
    ...
    text: `
      <div class="verse-row">
        <div class="verse-num">4:6</div>
        <div class="verse-content">
          Many people around me are asking, 'Who will show us good?' LORD, I'm answering that question with a prayer: Lift up the light of Your face upon us—for Your favor alone is the source of all true good.
        </div>
      </div>
    `,
    insight: `
      <p><strong>Connections:</strong> In 2 Corinthians 4:6, we see "the light of God's face" in Jesus Christ. John 1:14 describes His glory as full of grace and truth. Matthew 5:16 calls us to reflect that light to the world.</p>
  ...
  { label: "Psalm 4:7",
    ...
    text: `
      <div class="verse-row">
        <div class="verse-num">4:7</div>
        <div class="verse-content">
          God's favor brings deeper, greater joy than wealth ever could. My enemies' joy depends on external circumstances (grain and wine harvest). My joy is deeper because it comes from Your presence and favor.
        </div>
      </div>
    `,
    insight: `
      <p><strong>Spiritual joy > material joy.</strong> David's joy doesn't depend on harvest festivals or full granaries; it comes from knowing God. Being WITH God is better than having things FROM God.</p>
	  
	  <p><strong> I (David) may not have material abundance, I may be going through hardship, BUT I have something better, God's favor brings deeper, greater joy than wealth ever could. 
My enemies (persecutors and anyone whose joy depends on circumstances rather than God) joy depends on external circumstances which are temporary (grain, wine – harvest, festivals). 
My joy is deeper and greater than my enemies joy. My deep joy comes from Your presence and knowing Your favor is in me as king of Israel. </strong></p> 

<p> Even when they're at their happiest moment - celebrating an abundant harvest with plenty of food and wine - my joy in You surpasses theirs. Because my joy doesn't depend on circumstances. 
My joy comes from You and surpasses anything material prosperity could bring. </p>
 
<p> Spiritual joy > material joy
<br> God's presence > God's presents
<br> Being WITH God > having things FROM God
<br> Knowing Him > knowing abundance </p>
...
<p><em> Although David is being sought out to be killed David is at ease. </p></em>
   ...
   { label: "Psalm 4:8",
    ...
    `,
    insight: `
      <p><strong>Radical Trust:</strong> David isn't sleeping with one eye open. He falls into a deep, inner tranquility because God alone makes him secure. Apostle Paul teaches similarly in Philippians 4:6-7 about the peace that guards our hearts.</p>
      <p><strong>Jesus Sleeping in the Storm (Matthew 8:24):</strong> Even as the waves swamped the boat, Jesus was at rest. Can you sleep in the storm? If not, are you trying to secure yourself instead of letting God "make you dwell"?</p>
      <p><strong>Tidbit:</strong> The only time the Bible records Jesus sleeping was during the storm on the boat.</p>
	  
	  <p><strong> In peace I will both lie down and sleep, for you alone, O LORD, make me dwell in safety. 
This is remarkable - he's not saying "I'll stay up on guard" or "I'll sleep lightly with one eye open". David trust the Lord to protect him completely because GOD ALONE makes him secure. 
David has inner tranquility and is not tossing and turning in his sleep. </strong></p>

<p><em> Radical trust </em></p>
<p> David is at ease and falls asleep, even though his enemies are seeking to take his life. David is actually in danger of being killed. 
Yet he falls asleep and has complete inner peace because he radically trust in the Lord. David trust the Lord when He told David that he is to be king. David trust the Lord to keep him secure and safe. </p>

<p> A person ought not to trust in himself to fix all of his problems or fix the world. A person is only a sinful broken being. Everything comes from God even sleep itself. 
Look to Jesus as the solution to all of my affliction. </p>


<hr>

<p><em> Apostle Paul teaches similiarly: </em> 
<br><blockquote cite="https://www.esv.org/Philippians+4/">
...
<p><em> Jesus Sleeping in the Storm </em>
<br><blockquote cite="https://www.esv.org/Matthew+8/"> "And behold, there arose a great storm on the sea, so that the boat was being swamped by the waves; but he was asleep." </p>

<p> When they wake Him: <span style="color: red;"> "Why are you afraid, O you of little faith?" </span> (v. 26) </p>
<p> Matthew 8:23-27 </p>
</blockquote>

<hr>

<p><em> Question for us: </em>
<br> Can you sleep in the storm? 
<br> Can you rest when enemies surround you? 
<br> Can you lie down in peace when circumstances scream danger? </p>

<p><em> If not, why not? </em>
<br> Do you trust God + something else? (not "alone")
<br> Are you trying to secure yourself? (not letting God "make you dwell") 
<br> Are you looking for peace in circumstances? (not "in the LORD") 
</p>
<hr>
<p><em> Blessing: God gives us a framework on to walk through life </em>

<ol>
	<li> Although everything is not okay we are able to have inner peace knowing that the Lord has plans for us
	<li> We are in His favor and loving care
	<li> When we cry out in distress, God hears us
	<li> We do not need to worry about confronting enemies because God has set apart the faithful 
	<li> Ability to choose trust over anxiety because God's face shines on us 
	<li> Able to experience joy beyond circumstances because God gives joy 
	<li> Able to resting in perfect peace because God alone keeps us safe
</ol>

<hr>

<p><em> Prayer for sleep: </em>
<br> Although everything is not fine in my life, I might be in danger, I have not solved all of my problems, I am not in a safe place. 
...
Your salvation is sufficient. I rest in your care and not my own this night. </p>

<p><em> Tidbit: </em> 
<br> The only time the Bible records Jesus sleeping was during the storm on the boat. </p>

<hr>

<p><em> From Distress to Peace </em></p>

<ol>
	<li> "Answer me... in distress you have given me relief"
	<li> "How long will you attack my reputation?"
	<li> "Know that the LORD has set apart the faithful"
	<li> "Be angry but don't sin; reflect and be still"
	<li> "Offer right sacrifices and trust in the LORD"
	<li> "Many ask 'Who will show us good?' - LORD, lift up Your face"
	<li> "You've given me joy greater than harvest abundance"
	<li> "In peace I lie down and sleep - You alone keep me safe"
</ol>

<p> The progression: </p>

<ol>
    <li> Crisis (distress, enemies, slander) 
    <li> Prayer (crying out to God) 
    <li> Confrontation (addressing enemies) 
    <li> Instruction (how to respond rightly) 
    <li> Trust (putting confidence in God) 
    <li> Joy (experiencing God's favor) 
    <li> Peace (resting in God's security) 
</ol>
	
<p> From anxiety to shalom - through trust in God alone </p>
    `
  },
  ...
  /* --- PSALM 5 --- */
    ...
    ref: "ESV",
    insight: `
      <p><strong>Two Levels of Prayer:</strong> David distinguishes between <em>amarai</em> (clear words) and <em>hagigi</em> (internal groaning too deep for expression). God hears both. Groaning is a valid form of prayer.</p>
      <p><strong>Romans 8:26-27:</strong> Apostle Paul teaches that the Holy Spirit intercedes for us with "groanings too deep for words" when we don't know how to pray as we ought.</p>
   <hr> Wind instruments like the flute might have been chosen to accompany this psalm because they sound like groaning/sighing, which match David's internal groaning.
<br> Revised: LORD, listen carefully to my prayer—both what I can say clearly and what comes out as just groaning. Understand the depth beneath my words.
<br> David cannot articulate his prayer completely into words (groaning) and still prays for God to listen/understand:
<br> David request for God to carefully, attentively listen and understand/perceive the meaning behind David's internal sounds/thoughts (groaning) that are too deep for clear words that are wrestling internally in Davids mind and heart.
<hr><p> 
David teaches us that sometimes prayer has two levels:
אֲמָרַי - amarai (words) & הֲגִיגִי - hagigi (groaning)
</p><ol>
<li> Surface level: amarai (words) - what we can articulate (clear specific request)
<li> Deep level hagigi (groaning) - what we can feel but can't fully express
</ol></p><p>
Examples: Anguish too deep for words, longing that defies description, pain that comes out as groans, meditation that is more than thought
Daving teaches that God hears BOTH levels. God hears what we sometimes cannot say clearly. God understands inarticulation. God percieves the heart behind inadequate words. God does not require perfect eloquence. Groaning is a valid form of prayer. 
</p><p>
Prayer is sometimes beyond words. Permission to pray imperfectly. God wants honest faith. 
God invites human beings to honest & raw in prayer. That might just mean your prayer will be multilayered. 
</p><hr><p><em>
...
</em></p><blockquote cite="https://www.esv.org/Romans+8/">
"Likewise the Spirit helps us in our weakness. For we do not know what to pray for as we ought, but the Spirit himself intercedes for us with groanings too deep for words. And he who searches hearts knows what is the mind of the Spirit, because the Spirit intercedes for the saints according to the will of God."
Human beings are limited so that we can't always express what we feel because the pain might be too great, desire too intense, need too deep, confusion too complex. The emotions that we feel sometimes overwhelm us to the point we cannot put our words together. 
</blockquote><p>
Romans 8:26-27
</p><p>
...
<span class="selah-marker"><em>AMEN</em></span>
   ...
   { label: "Psalm 5:2",
    ...
    text: `
      <div class="verse-row">
        <div class="verse-num">5:2</div>
        <div class="verse-content">
          Give attention to the sound of my cry, <em>shava</em> (שַׁוַע), my King and my God, for to you do I pray.
        </div>
      </div>
    `,
    insight: `
      <p><strong>Escalation:</strong> David moves from calm words to groaning, and now to a <em>shava</em>—a desperate, loud cry for rescue. He appeals to God as "King" (authority) and "my God" (personal covenant relationship).</p>
      <p><strong>Jesus' Appeal:</strong> On the cross, Jesus cries "My God, my God" to appeal to God's promises even in abandonment. We should do the same in our distress.</p>
    David is escalating - from calm words → to groaning → to CRYING OUT 
<br> שַׁוַע (shava): Desperation , Urgent need , Danger or distress , Loud, vocal outcry (not silent prayer), Call for rescue/deliverance , Life-or-death intensity 
<br> This is NOT casual prayer - it's DISTRESS 
</p><hr><em>
David appeals to God (1/2) 
</em></p><p><em>
my King and my God: 
</em></p><p>
...
<br> Not just "God" (distant, general)  but “my God” (personal, covenant relationship)
<p><em>
...
<br> Even when Jesus was truly abandoned He address God as “my God” to appeal to Gods promises. People ought to appeal to Gods promises and be comforted because we are not abandoned. 
</p><p>
KING = Power, Authority, Protection, Resources
<br> GOD = Personal Relationship, Covenant, Devotion 
</p>
When beginning the pray David appeals to Gods royalty over all people and covenant(s) or promises made to His people. 
<p><em>
Davids logic: 
</em></p><p>
...
<br> Looking forward to <a href="#psalm-5v4"> Psalm 5, Verse 4 </a><strong> "BECAUSE You are not a God who delights in wickedness" </strong>
</p><p id="reasons-continued">
<em>Reasons continued...</em>
</p><p>
...
<br> Therefore David brings his case to the God who hates wickedness, who will judge evil, who cannot coexist with wrongdoing, who will act against the wicked.
</p><p><em>
...
<br> It’s also a fact that David is stating. 
<br> David’s prayer has overlap with worshiping God. 
</p><hr><em>
...
<br> Level 1: WORDS (v. 2a) What we can articulate clearly, Specific requests , Coherent thoughts 
<br> Level 2: GROANING (v. 2b) What's beneath the words, Too deep to express clearly Sighs, meditations, longings 
<br> Level 3: CRYING OUT (v. 3) Desperate, urgent, vocal, "HELP! SAVE ME! PLEASE!", Raw emotion, unfiltered need 
</p><p>
All three are valid prayer. God hears all three.
  ...
  { label: "Psalm 5:3",
    ...
    insight: `
      <p><strong>The Watchman:</strong> David uses the image of a watchman on a tower—vigilant and patient—waiting for God to act. (Connections: Isaiah 21:6-8, Habakkuk 2:1).</p>
      <p><strong>First Fruits Principle:</strong> Give God the first of your day before the world distracts you. David treats his prayer like the morning sacrifice offered by Israelite priests on the altar.</p>
    
	<p><strong>
I prepare a <u>sacrifice</u>...
</strong></p>
<p>
...
<br><sub> Romans 12:1, Hebrews 13:15 </sub>
<p> David did this by ordering it formally and carefully according to God's requirments.
</p><p><em>
<img src="altar.png" alt="altar" width="auto" height="200" />
<p> David uses these words to describe how he arrange his prayer:
</em></p><p>
...
<ol>
	<li> To arrange troops in battle formation, to line up for war
	<br><sub> 1 Samuel 17:8, Judges 20:20, Job 6:4.
	<li> To arrange sacrifice on the altar, to lay out offerings before God in proper order
	<br><sub> Leviticus 1:7-8, 1:12, 6:12, 24:8 
	<li> To arrange in proper sequence, to organize systematically
	<br><sub> Psalm 40:5, Job 33:5
</ol>
<hr><p><strong>
...for you and <u> watch</u>.
</strong></p><p>
"<u>Watch/Wait</u>" - וַאֲצַפֶּה (Va'atzappeh)
</p><p>
Root: צָפָה (tzafah) = to watch, look out, spy, keep watch
<br><sub> Isaiah 21:6-8 (watchman on the tower), Habakkuk 2:1, Micah 7:7, 2 Kings 9:17 </sub>
</p><p>
David uses a watchman as an image to describe himself while waiting. 
<br>This means that he will remain vigilant, patient while expecting someone/something.
</p><p>
<img src="watchman.png" alt="Watchman Illustration" width="auto" height="250" />
</p><hr><p>
<p>
David mentions the <strong><u>morning</u></strong> twice. 
</p><p>
Isrealite priest would offer sacrafices according to a daily pattern. 
<br>The pattern was <u>morning</u> and evening/twilight.
<br><sub> Exodus 29:38-42, Leviticus 6:12, Numbers 28:4</sub>
</p><p> 
Again David is treating his prayer like a sacrafice on the altar. 
</p><p>
Morning might be emphasized by David because of <em>other connections</em>.
</p><hr><em>
Other connections 
</em></p><ol>
...
Side notes
	...
	<li> The "First Fruits Principle" is reflected in the "Word before World, Return to the Word" devotional study method that I personally have used and recommend.
	<li> The mind is most fresh first thing in the morning and can handle deeper study better than later in the day. 
</ul>
	`
  },
 { label: "Psalm 5:4",
    ...
    `,
    insight: `
      <p><strong>Wickedness (Resha) vs Evil (Ra):</strong> God and evil are completely incompatible. Evil cannot even "lodge" or "sojourn" as a guest with God. Because God is holy, David can have confidence in his prayer against evil.</p>
      <p><strong>Approach through Christ:</strong> As sinful people, we can only approach this holy God through the perfect sacrifice of Jesus Christ, who justifies us (Hebrews 10:10-14).</p>
    
	<p>
	 כִּי (ki) - "For, because" You (God) are...
<br> לֹא (lo) - "Not"
<br> אֵל־חָפֵץ (el-chafetz) - "A God who delights/takes pleasure" in... 
<br> רֶשַׁע (resha) - "Wickedness, wrongdoing, evil": Moral corruption, injustice, violence
<br> רָע (ra) - "Evil, evil person, evildoer"
<br> לֹא יְגֻרְךָ (lo y'gurkha) - "May not dwell with / will not sojourn with": cannot coexist with...
<br> אָתָּה (attah) - "You" (God)
</p><hr><p>
David speaks about God's charecter: <em>God Does NOT Delight in Evil</em>
</p><hr><p>
<em>Both Resha and Ra are mentioned</em>
</p><p>
רֶשַׁע (Resha) - "Wickedness"
<br>An abstract concept: Moral corruption, Wrongdoing, Active evil, Injustice
</p><p>
 רָע (Ra) - "Evil/Evil person"
<br> Can be abstract (evil) or concrete (the evil person/evildoer), The one who practices wickedness, Wickedness personified
</p><p>
Together they cover: the principle of wickedness itself and the practitioner as wickendness personified 
</p><p>
Neither the principle of evil nor the evil person can <u> dwell </u> with God.
</p><p><strong><hr>
evil may not <u>dwell</u>...
</strong></p><p>
 יְגֻרְךָ (Y'gurkha) - <u>Dwell</u>
 <br>Root גּוּר (gur): to dwell, sojourn, stay, lodge, be a guest
</p><p>
Evil isn't even briefly allowed to coexist with God.
<br><sub>Psalm 15:1-2, Psalm 24:3-4, Habakkuk 1:13, Isaiah 59:2, Revelation 21:27
</p><p>
...
<br><sub> <a href="#reasons-continued"> Reasons continued... </a></sub>
<hr><p>
...
<br><sub>Isaiah 6:3, Leviticus 11:44, 1 John 1:5 </sub>
</p><p>
...
<em>The tension of approaching God as a sinner</em>
<p></p>
At this point it is revealed that God's nature is opposed to sinfulness. We people are sinful creatures.
<br> This creates tension: If God cannot tolerate evil, and we are sinful, how can we approach Him?
<br><sub> Romans 3:23, Isaiah 64:6 </sub>
</p><p>
...
<ul>
	...
	<li> If evil can't dwell with God, we must pursue holiness
</ul>
<sub> 1 Peter 1:15-16 </sub>
<ul>
	<li> God's holiness is absolute
	<li> Have confidence in our prayer against evil by trusting the Lord (faithfullness)
	<li> We can appeal to God's character: "God, You hate wickedness - so please act against this evil!"
	<li> Take sin seriously 
</ul>
<sub> Hebrews 12:14 </sub>
</p><hr><p>
...
{ label: "Psalm 5:5",
    ...
    `,
    insight: `
      <p><strong>Shall Not Stand:</strong> This implies standing before royalty or authority. The boastful are barred from God's presence and court. Through Christ, however, God's wrath was poured out on Jesus so we could be justified to stand before Him.</p>
      <p><strong>Prayer:</strong> Lord God Heavenly King, I bring this situation before You because You hate wickedness... I come not as an evildoer, but as Your servant seeking Your righteousness.</p>
    
	<p><strong>
"The Boastfull..."
</p></strong>
<u>Boastful</u> - הוֹלְלִים (hol'lim) 
<br> Root: הָלַל (halal)
</p><p>
The people who are looking to their own abilities/wisdom/power instead of God. Who are acting presumptuously before God, showing no restraint or fear of God.
<br> The people being reckless in their wickedness who exalt themselves rather than submitting to God. Who act like madmen by being uncontrollable and unreasonable. 
</p><p>
The boastful are morally/spiritually insane because they are foolish enough to think they can stand before God unrepentant. 
<br>They are arrogant enough to present themselves boldly in wickedness and assume God will tolerate them.
<br><sub> 1 Samuel 21:13-15, Ecclesiastes 7:7, Ecclesiastes 2:2, Isaiah 44:25
</p><p>
David is most likely talking about his advesaries who seek to kill him (Absolam and others) who are in opposition to God. 
<br> In modern day times this would mean non Christians. 
</p><p><hr><strong>
"Shall Not Stand..."
</strong></p><p>
לֹא־יִתְיַצְּבוּ (Lo-yityatzvu)
<br> Root: יָצַב (yatzav)
</p><p>
Present oneself voluntarily, standing before royalty/authority, taking position.
<br><sub>Genesis 18:22, 1 Kings 10:8, Jeremiah 15:19, Deuteronomy 10:8</sub>
</p><p>
The boastful cannot present themselves before God.
<br> They will not be allowed to stand in His presence.
<br> They have no access to God's court.
<br> They are barred from His presence.
</p><hr><p><strong>
"Before Your Eyes..."</strong><p> 
לְנֶגֶד עֵינֶיךָ (L'neged eineikha)
<br> לְנֶגֶד (l'neged) - in front of, before, opposite, in the sight of
</p><p>
Not hidden but in full view.
</p><p><hr><strong>
"You Hate..."</strong> 
</p><p>
שָׂנֵאתָ (Saneita)
<br> Root: שָׂנֵא (sane) - to hate, to be hostile toward, to be an enemy of
</p><p>
God's hatred is a moral opposition and not just arbitrary dislike by being activly hostile and not passive just indifferent.
<br> Incompatibile with His nature (Holy rejection).
<br><sub><a href="#reasons-continued"> God is fundemantally opposed to Evil </a></sub>
</p><p>
This is a judicial response by God where righteous judgment against evil occurs.
</p><p>
This means God is actively opposed to evildoers and cannot tolerate workers of iniquity.
<br> Because of this, God will act against them in judgment, where there is no neutrality. 
</p><p>
God hates evil and evildoers.
</p><hr><p><strong>
"Workers of Iniquity"</strong> 
<br> פֹּעֲלֵי אָוֶן (Po'alei Aven)
</p><p>
This phrase appears FREQUENTLY in the Psalms:
<br>Psalm 6:8, Psalm 14:4, Psalm 28:3, Psalm 36:12, Psalm 92:7, 9 
</p><p>
פֹּעֵל (po'el) = worker, doer, practitioner
<br> Not just occasional sin, but habitual practice. Professional evildoers who make a business of wickedness.
</p><p>
אָוֶן (aven) = iniquity, wickedness, trouble, mischief
<br> Comprehensive term for moral evil. Implies both the evil itself and the trouble it causes. Often associated with deception, violence, injustice.
</p><p>
Workers of iniquity are people who habitually practice wickedness as their way of life specializing in evil. 
<br> Those whose occupation is wrongdoing: professional evildoers.
</p><p>
Examples: scam artist, corrupt politician/judges/police, exploitative landowners, usurers, false prophets and witches, prostotutes
</p><p><hr>
<em> Usury </em> 
</p><p>
נֶשֶׁךְ (nešek): A Bite
<br> תַּרְבִּית (tarbit): Increase/Multiplication
</p><p>
The compounding nature of debt. The usurer "works" by doing nothing—letting time and the debtor's desperation "multiply" their own wealth.
</p><p>
Like a snakebite, the initial wound is small, but the "venom" (accruing interest) eventually spreads and destroys the person’s entire livelihood.
<br><sub> Exodus 22:25, 25:36–37, 23:19–20, Ezekiel 18:13<sub>
</p><p>
Ancient Isrealites viewed any loan with interest to a brother Isrealite as אָוֶן (ʾāwen)—vanity or "empty" gain that carries a curse.
<br> The only time that interest was acceptable was if it was to a foreigner and a commercial loan (as a method for the foreigner to make money).
</p><p>
The view on interest changed over time to the (non)secular world and to modern Christians. 
<br> The secular world viewing it as "the price for money". Islam labeling it as Haram. In Judaism Torah law (Halakha), forbids interest to other Jews without a partnership agreement. 
<br> Christians viewing it as conditional (if the interest is fair it is not considered sinful). John Calvin spearheaded this sentiment. 
</p><p><hr>
<em> Verse 4 and 5 together </em>
</p><p>
<strong>"The boastful may not stand before Your eyes"</strong> (their inability)
<br><strong> "You hate all workers of iniquity" </strong> (God's response)
</p><p>
The wicked cannot access God's presence because God hates them (actively opposes) by being Holy/seperate.
</p><p>
<img src="John_Martin_The_Creation_of_Light.jpg" alt="John_Martin_The_Creation_of_Light" width="auto" height="500" />
<br> John Martin "The Creation of Light"
</p><p><hr>
<em>David appeals to God continued...</em>
</p><p>
In verse 2 David appealed to God's covenental relationship with himself by addressing God as Lord and King, therefore God ought to attend to his prayer.
<br> In verse 4 David appeals to God because God is in active opposition to evil. 
<br> Now in verse 5 David is appealing to God because he can himself present himself before God not as an evildoer.
</p><p>
While his wicked enemies cannot stand before God. 
<br> Therefore God will act against them, not him because he aligns himself with God. 
<br> His enemies align themselves with wickedness. God hates wickedness and those who practice it.
<br> Therefore God will judge David's enemies.
</p><p>
Appeals to God in the same manner elsewhere: Psalm 1:5, Malachi 3:2, Revelation 6:15-17, Romans 1:18, 30
</p><p><hr>
<em>The Difficult Truth: God Hates</em>
</p><p>
The modern world is discomforted by "God Hates"
</p><p>
Our culture says:
<br> "God is love" (true - 1 John 4:8)
<br> "God loves everyone" (true - John 3:16)
<br> "God doesn't hate anyone" (NOT what the Bible says)
</p><p>
Scripture clearly teaches that God hates sin and also evildoers / workers of iniquity.
</p><p><hr>
<em> How to Reconcile with This? </em>
</p><p>
God's Love and Hate Are Both Holy.
</p><p>
God loves righteousness → Therefore He hates wickedness
<br> God loves His creation → Therefore He hates those who destroy it through evil
</p><p>
You cannot love good without hating evil.
<br> You cannot love the innocent without hating those who harm them.
<br> You cannot love justice without hating injustice.
</p><p><hr>
<em> God's Hatred Is Moral, Not Arbitrary </em>
</p><p>
God doesn't hate capriciously like humans do because His hate is not based on personal offense, preferences, or emotions getting out of control.
<br> God's hatred is a moral response to evil in the form of judicial opposition to wickedness.
<br> God's hatred is righteous anger at injustice and a Holy rejection of what contradicts His nature.
</p><p><hr>
<em>Mercy</em>
</p><p>
"Have I any pleasure in the death of the wicked, declares the Lord GOD, and not rather that he should turn from his way and live?"
<br><sub> Ezekiel 18:23 </sub>
</p><p>
While God hates those who practice evil habitually.
<br> He still offers mercy and a Way out (salvation).
</p><p>
God desires that the wicked repent of their evil ways. 
<br> This gives the evildoers a future possibility to be recieved by God.
</p><p><hr>
<h4><em>The Good News of Our Atoning Salvation</em></h4>
</p><p>
In Christ Jesus' atoning death, God's Wrath Was Satisfied.
</p><p>
"But God shows his love for us in that while we were still sinners, Christ died for us. Since, therefore, we have now been justified by his blood, much more shall we be saved by him from the wrath of God. For if while we were enemies we were reconciled to God by the death of his Son, much more, now that we are reconciled, shall we be saved by his life."
<br><sub> Romans 5:8-10 </sub>
</p><p>
But through Christ God's wrath was poured out on Jesus, justifying our status as sinful and evildoing people as justified and able to present ourselves before God.
</p><p><hr>
<em>Prayer</em>
</p><p>
As part of a petition of prayer we are able to appeal to God's covenenantal relationship by addressing God as Lord and King. 
<br> Appealing to God because God is in active opposition to evil.
<br> And appealing to God because we are able to present ourselves before God not as an evildoer.
</p><p>
"Lord God Heavenly King, I bring this situation before You because You hate wickedness, and I ask You to oppose [wickedness/situation]. 
<br> I come before You not as an evildoer, but as Your servant seeking Your righteousness. 
<br> I appeal to the covenant You have made with Your people, trusting that You are faithful to Your word. 
<br> Amen."
</p><p><hr>
...
<br> Abhor (תָּעַב - ta'av) = even stronger - visceral disgust, loathing, revulsion
</p><p>
Abhor conveys more than an intellectual disapproval. 
It conveys a visceral disgust of loathing, revulsion to point of not being able to stand the sight of something.
This is similiar to smelling something rotten and recoiling or 
seeing something vile and turning away in disgust. It's a 
physical reaction to something repulsive.
</p><p>
God's response to bloodshed and deceit is not 
just "I disagree with this", 
but "I am utterly disgusted by this.
...
<li>Laban deceiving Jacob (Genesis 29) - giving Leah instead of Rachel
<li>Potiphar's wife (Genesis 39) - false accusation against Joseph
<li>Delilah deceiving Samson (Judges 16) - betraying him to the Philistines
...
<li>Cain (Genesis 4):
<ul>
<li>Deceit: "Am I my brother's keeper?" (lying about what happened)
<li>Bloodshed: Murdered Abel
</ul>
<li>David and Uriah (2 Samuel 11):
<ul>
<li>Deceit: Tried to cover up his sin through trickery
<li>Bloodshed: Had Uriah killed
</ul>
<li>Jezebel and Naboth (1 Kings 21):
<ul>
<li>Deceit: False witnesses, fake trial
<li>Bloodshed: Naboth stoned to death based on lies
</ul>
<li>Herod and John the Baptist (Mark 6):
<ul>
...
<em>New Testiment Connections: Christians and Sin</em>
</p><p>
Liars and murders are mentioned as condemned as a final judgment in Revelation 21:8.
</p><p>
In John 8:44 when Jesus was speaking to a group of Jewish leaders and people who had gathered in the Temple treasury. Jesus characterizes the devil as a murder and the father of lies. 
Therefore those who practice murder and lying reveal that their true father is the devil instead of God.
</p><p>
In the Book of Ephesians 4:25 Christians are called to put away lies, speak truth, and be trustworthy:
<br><strong>"Therefore, having put away falsehood, let each one of you speak the truth with his neighbor, for we are members one of another."</strong> 
</p><p>
<em>Christians belong to the God of truth who abhors lies.</em> 
</p><p>
Lying belongs to the "old self" - the person we were before Christ:
<br><strong>"Do not lie to one another, seeing that you have put off the old self with its practices and have put on the new self, which is being renewed 
in knowledge after the image of its creator."</strong> <sub>Colossians 3:9-10</sub>
</p><p>
<strong>"For 'Whoever desires to love life and see good days, let him keep his tongue from evil and his lips from speaking deceit. Let him turn away from evil and do good; 
let him seek peace and pursue it.'"</strong> <sub> 1 Peter 3:10-11 </sub>
</p><p>
To love life keep tongue from evil, lips from deceit, and turn from evil.
To do the opposite brings God's judgment (destruction/abhorrence).
</p><p><hr>
<em>Building a Case (2/2)</em>
</p><p>
David is building to his petition for God to act against his enemies.
<br> v. 4 - You don't delight in wickedness; evil can't dwell with You (God's character)
<br> v. 5 - The boastful can't stand before You; You hate evildoers (God's emotion)
<br> v. 6 - You destroy liars; You abhor violent deceivers (God's action + stronger emotion)
</p><p>
Here's who God is (holy)
<br>Here's what God hates (evil)
<br>Here's what God does (destroys the wicked)
...
<ul>
<li><strong>Discipline</strong> (<span dir="rtl">יָסַר</span> yasar) — corrective, formative, the response of a father to a son. Painful but purposeful. <small>Proverbs 3:11&#8211;12; Hebrews 12:5&#8211;11</small></li>
...
<p>
For the Christian, the wrath David feared has been absorbed by Christ on the cross. <small>Romans 5:9; Romans 8:1</small> What remains for the believer is discipline, not condemnation. Hebrews 12 makes this explicit: "the Lord disciplines the one he loves" — God's correction of the believer is proof of sonship, not abandonment. <small>Hebrews 12:5&#8211;6</small>
</p>
<hr>
<blockquote class="church-voice">
...
<p>
<strong>"The Lord disciplines the one he loves, and chastises every son whom he receives."</strong> <small>Hebrews 12:6</small>
...
<p>
<strong>"There is therefore now no condemnation for those who are in Christ Jesus."</strong> <small>Romans 8:1</small>
...
<ol>
<li>God is glorified when His people praise Him <small>Psalm 22:23; Isaiah 43:21; John 4:23&#8211;24</small></li>
<li>The dead in Sheol are cut off from the covenant community's active praise <small>Psalm 88:10&#8211;12; Isaiah 38:18</small></li>
<li>Therefore saving David gains God a living worshiper</li>
</ol>
<p>
The argument reflects OT theology at a specific stage — the full hope of bodily resurrection and eternal praise was still emerging. David prays within his understanding, and God honors it. The Sheol argument is ultimately transcended by the Resurrection: Christ has conquered death, and those who die in faith are with Christ, not silenced. <small>Daniel 12:2; Job 19:25&#8211;27; 1 Corinthians 15:20&#8211;22; Philippians 1:21&#8211;23</small> But David's instinct — that God's glory is served by the praise of His people — is permanently valid.
</p>
<p>
  <span class="selah-marker">
    [ <em>SELAH AMEN</em> ]
...
<p><strong>New Testament Connections</strong></p>
<p>
<strong>The name hidden in the petition:</strong> <em>Hoshi'eni</em> — "save me!" — from the root יָשַׁע (yasha). This is the exact root of Yeshua (Jesus). Matthew 1:21: "You shall call his name Jesus, for he will save his people from their sins." <small>cf. Acts 4:12</small> Every messianic "save me!" in the Psalms is already praying in the name of the One who would answer.
</p>
<p>
<strong>Resurrection as the answer to Sheol:</strong> "Death is swallowed up in victory. O death, where is your sting?" <small>1 Corinthians 15:54&#8211;55; Acts 2:24, 31&#8211;32</small> The fear David articulated — that death silences praise — is answered definitively in the empty tomb. Christ rose from Sheol, and those who die in Him are with Him, not silent.
</p>
<hr>
<p><em>Prayer</em></p>
<p>
...
<p><strong>New Testament Connections</strong></p>
<p>
<strong>"Jesus wept."</strong> <small>John 11:35</small> The Son of God cried at the tomb of Lazarus. He does not stand over human grief as an observer — He enters it. He who "bore our griefs and carried our sorrows" <small>Isaiah 53:4</small> wept at the same kind of loss that reduces David to soaking his bed with tears.
</p>
<p>
<strong>"The Spirit himself intercedes for us with groanings too deep for words."</strong> <small>Romans 8:26</small> Paul's description of the Spirit interceding with "groanings" is the NT completion of David's anakhah (v.6). The Spirit prays the prayers we cannot form. When David's words run out and only the moaning remains, the Spirit is already interceding in that gap.
</p>
<hr>
<p><em>Prayer</em></p>
<p>
...
<br><strong>Matthew 7:23:</strong> Jesus says at the judgment: "I never knew you; depart from me, you workers of lawlessness" — a <em>direct quotation</em> of the LXX. <small>Matthew 7:23; Luke 13:27; Matthew 25:41</small>
</p>
<p>
What this means:
</p>
...
<p>
<strong>"He offered up prayers and supplications, with loud cries and tears, to him who was able to save him from death, and he was heard because of his reverence."</strong> <small>Hebrews 5:7</small>
</p>
<p>
Hebrews 5:7 describes Jesus in Gethsemane using lament psalm language. Jesus prayed Psalm 6. He was heard. The answer was the Resurrection. Our confidence that God hears us is anchored in the fact that God definitively heard the perfect Pray-er — and raised Him on the third day. <small>Romans 8:34; 1 John 2:1&#8211;2; Acts 2:24, 31&#8211;32</small>
</p>
<hr>
<p><em>Prayer</em></p>
<p>
